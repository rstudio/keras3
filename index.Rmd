...
The R interface to Keras uses [TensorFlow](https://rstudio.github.io/tensorflow/) as it's underlying computation engine. Therefore, you need to install both the keras R package as well as the the TensorFlow engine.
...
This will provide you with a default installation of TensorFlow suitable for use with the keras R package. See the [article on TensorFlow installation](https://rstudio.github.io/tensorflow/installation.html) to learn about more advanced options.
