...
The R interface to Keras uses [TensorFlow](https://rstudio.github.io/tensorflow/) as it's underlying computation engine. Therefore, you need to install TensorFlow (version 1.1 or higher) before using the package. 

Instructions for installing TensorFlow are here: <https://www.tensorflow.org/install/>.
