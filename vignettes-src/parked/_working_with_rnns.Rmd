...
# tether: https://raw.githubusercontent.com/keras-team/keras-io/master/guides/_working_with_rnns.py
# hidden upstream
---
...
See [Making new Layers & Models via subclassing](making_new_layers_and_models_via_subclassing.html)
...
For more details, please visit the API docs for `layer_rnn()`.
