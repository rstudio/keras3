...
date: 'Last Modified: 2023-11-21; Last Rendered: 2023-11-22'
vignette: >
...
- If you pass arrays, by calling `fit(x, y, ...)`, then `data` will be the tuple
`(x, y)`
...
```
## Epoch 1/3
## 32/32 - 0s - 8ms/step - loss: 2.9118 - mae: 1.3597
## Epoch 2/3
## 32/32 - 0s - 1ms/step - loss: 2.6026 - mae: 1.2856
## Epoch 3/3
## 32/32 - 0s - 699us/step - loss: 2.3378 - mae: 1.2193
```
...
- We start by creating `Metric` instances to track our loss and a MAE score (in `initialize()`).
...
custom_model <- new_model_class(
  ...
  train_step = function(data) {
    ...
    with(tf$GradientTape() %as% tape, {
      y_pred <- self(x, training = TRUE)
      loss <- loss_mean_squared_error(y, y_pred)
    })
...
```
## Epoch 1/5
## 32/32 - 0s - 5ms/step - loss: 2.6469 - mae: 1.2901
## Epoch 2/5
## 32/32 - 0s - 713us/step - loss: 2.4090 - mae: 1.2306
## Epoch 3/5
## 32/32 - 0s - 678us/step - loss: 2.2032 - mae: 1.1763
## Epoch 4/5
## 32/32 - 0s - 631us/step - loss: 2.0239 - mae: 1.1270
## Epoch 5/5
## 32/32 - 0s - 657us/step - loss: 1.8687 - mae: 1.0827
```
...
```
## Epoch 1/3
## 32/32 - 0s - 6ms/step - loss: 0.1607 - mae: 1.3018
## Epoch 2/3
## 32/32 - 0s - 737us/step - loss: 0.1452 - mae: 1.2999
## Epoch 3/3
## 32/32 - 0s - 701us/step - loss: 0.1335 - mae: 1.2986
```
...
```
## 32/32 - 0s - 2ms/step - loss: 0.0000e+00 - mae: 1.3947
```
...
all_digits <- k_concatenate(list(x_train, x_test))
...
```
## <keras.src.losses.losses.BinaryCrossentropy object at 0x2c95bdd20>
```
...
```
## 100/100 - 22s - 222ms/step - d_loss: 0.0000e+00 - g_loss: 0.0000e+00 - loss: 0.0000e+00
```
