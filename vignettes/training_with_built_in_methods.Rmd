...
## Epoch 2/2
## 782/782 - 1s - 684us/step - loss: 0.1651 - sparse_categorical_accuracy: 0.9520 - val_loss: 0.1389 - val_sparse_categorical_accuracy: 0.9598
```
...
```
## 79/79 - 0s - 473us/step - loss: 0.1344 - sparse_categorical_accuracy: 0.9591
```
...
## Epoch 2/2
## 782/782 - 1s - 726us/step - loss: 0.0081
```
...
```
## Epoch 1/3
## 782/782 - 1s - 854us/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 0s - 597us/step - categorical_true_positives: 362643.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 0s - 622us/step - categorical_true_positives: 363298.0000 - loss: 0.1178
```
...
```
## 782/782 - 1s - 798us/step - loss: 2.3949
```
...
```
## Epoch 1/3
## 782/782 - 1s - 956us/step - loss: 0.3417 - sparse_categorical_accuracy: 0.9033
## Epoch 2/3
## 782/782 - 0s - 628us/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 0s - 619us/step - loss: 0.1166 - sparse_categorical_accuracy: 0.9652
```
...
```
## 157/157 - 0s - 658us/step - loss: 0.1136 - sparse_categorical_accuracy: 0.9637
```
...
## Epoch 2/3
## 100/100 - 0s - 640us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 713us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 1s - 947us/step - loss: 0.3687 - sparse_categorical_accuracy: 0.9026
```
...
```
## 782/782 - 1s - 884us/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
## Epoch 2/20
## 625/625 - 0s - 789us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 0s - 724us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1294 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
## 625/625 - 0s - 775us/step - loss: 0.0984 - sparse_categorical_accuracy: 0.9707 - val_loss: 0.1213 - val_sparse_categorical_accuracy: 0.9647
## Epoch 5/20
## 625/625 - 0s - 736us/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9763 - val_loss: 0.1146 - val_sparse_categorical_accuracy: 0.9669
## Epoch 6/20
## 625/625 - 0s - 748us/step - loss: 0.0680 - sparse_categorical_accuracy: 0.9808 - val_loss: 0.1144 - val_sparse_categorical_accuracy: 0.9679
## Epoch 7/20
## 625/625 - 0s - 717us/step - loss: 0.0576 - sparse_categorical_accuracy: 0.9838 - val_loss: 0.1172 - val_sparse_categorical_accuracy: 0.9677
## Epoch 8/20
## 625/625 - 0s - 727us/step - loss: 0.0492 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1165 - val_sparse_categorical_accuracy: 0.9707
...
## 625/625 - 0s - 769us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9468 - val_loss: 0.1491 - val_sparse_categorical_accuracy: 0.9572
```
...
```
## 1563/1563 - 1s - 795us/step - loss: 0.1362 - sparse_categorical_accuracy: 0.9602
```
