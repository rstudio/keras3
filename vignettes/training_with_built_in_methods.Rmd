...
[guide to multi-GPU & distributed training](distributed_training_with_tensorflow.html).
...
```
## 79/79 - 1s - 7ms/step - loss: 0.1353 - sparse_categorical_accuracy: 0.9589
```
...
## Epoch 2/2
## 782/782 - 1s - 1ms/step - loss: 0.0081
```
...
```
## Epoch 1/3
## 782/782 - 3s - 3ms/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
...
```
## Epoch 1/3
## 782/782 - 3s - 4ms/step - loss: 0.3419 - sparse_categorical_accuracy: 0.9032
## Epoch 2/3
## 782/782 - 1s - 2ms/step - loss: 0.1604 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
...
## Epoch 2/3
## 100/100 - 0s - 906us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 928us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 3s - 4ms/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
```
## 782/782 - 3s - 3ms/step - loss: 0.3843 - sparse_categorical_accuracy: 0.8999
```
...
```
## 4/4 - 2s - 449ms/step - loss: -1.3254e+00
```
...
```
## Epoch 1/20
## 625/625 - 2s - 4ms/step - loss: 0.3727 - sparse_categorical_accuracy: 0.8946 - val_loss: 0.1909 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/20
...
See the [callbacks documentation](https://keras.posit.co/reference/index.html#callbacks) for the complete list.
...
```
## 1563/1563 - 3s - 2ms/step - loss: 0.2949 - sparse_categorical_accuracy: 0.9148
```
