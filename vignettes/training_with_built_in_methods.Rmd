...
## Epoch 2/2
## 782/782 - 1s - 854us/step - loss: 0.1651 - sparse_categorical_accuracy: 0.9519 - val_loss: 0.1387 - val_sparse_categorical_accuracy: 0.9602
```
...
```
## 79/79 - 0s - 3ms/step - loss: 0.1347 - sparse_categorical_accuracy: 0.9591
```
...
## Epoch 2/2
## 782/782 - 1s - 675us/step - loss: 0.0081
```
...
## Epoch 2/3
## 782/782 - 1s - 723us/step - categorical_true_positives: 362643.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 678us/step - categorical_true_positives: 363325.0000 - loss: 0.1179
```
...
```
## Epoch 1/3
## 782/782 - 2s - 2ms/step - loss: 0.3417 - sparse_categorical_accuracy: 0.9033
## Epoch 2/3
## 782/782 - 1s - 723us/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 1s - 717us/step - loss: 0.1166 - sparse_categorical_accuracy: 0.9653
```
...
## Epoch 2/3
## 100/100 - 0s - 694us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 703us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 4/4 - 1s - 238ms/step - loss: -1.3254e+00
```
...
## Epoch 2/20
## 625/625 - 1s - 906us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 1s - 871us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1294 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
## 625/625 - 1s - 863us/step - loss: 0.0984 - sparse_categorical_accuracy: 0.9707 - val_loss: 0.1213 - val_sparse_categorical_accuracy: 0.9647
## Epoch 5/20
## 625/625 - 1s - 880us/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9762 - val_loss: 0.1153 - val_sparse_categorical_accuracy: 0.9667
## Epoch 6/20
## 625/625 - 1s - 904us/step - loss: 0.0683 - sparse_categorical_accuracy: 0.9803 - val_loss: 0.1142 - val_sparse_categorical_accuracy: 0.9680
## Epoch 7/20
## 625/625 - 1s - 867us/step - loss: 0.0578 - sparse_categorical_accuracy: 0.9835 - val_loss: 0.1142 - val_sparse_categorical_accuracy: 0.9694
## Epoch 8/20
## 625/625 - 1s - 880us/step - loss: 0.0493 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1156 - val_sparse_categorical_accuracy: 0.9708
## Epoch 9/20
## 625/625 - 1s - 879us/step - loss: 0.0423 - sparse_categorical_accuracy: 0.9882 - val_loss: 0.1175 - val_sparse_categorical_accuracy: 0.9716
...
## 625/625 - 1s - 2ms/step - loss: 0.3759 - sparse_categorical_accuracy: 0.8940 - val_loss: 0.1932 - val_sparse_categorical_accuracy: 0.9447
## Epoch 2/2
##
## Epoch 2: val_loss improved from 0.19317 to 0.14933, saving model to mymodel_2.keras
## 625/625 - 1s - 907us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9469 - val_loss: 0.1493 - val_sparse_categorical_accuracy: 0.9576
```
