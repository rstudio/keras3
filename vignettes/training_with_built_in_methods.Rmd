...
```
## Epoch 1/2
## 782/782 - 2s - 3ms/step - loss: 0.3482 - sparse_categorical_accuracy: 0.9004 - val_loss: 0.1977 - val_sparse_categorical_accuracy: 0.9447
## Epoch 2/2
## 782/782 - 1s - 1ms/step - loss: 0.1653 - sparse_categorical_accuracy: 0.9516 - val_loss: 0.1391 - val_sparse_categorical_accuracy: 0.9605
```
...
```
## 79/79 - 0s - 5ms/step - loss: 0.1351 - sparse_categorical_accuracy: 0.9586
```
...
## Epoch 2/3
## 782/782 - 1s - 841us/step - categorical_true_positives: 362642.0000 - loss: 0.1623
## Epoch 3/3
## 782/782 - 1s - 836us/step - categorical_true_positives: 363341.0000 - loss: 0.1177
```
...
## Epoch 2/3
## 782/782 - 1s - 858us/step - loss: 0.1604 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 1s - 803us/step - loss: 0.1176 - sparse_categorical_accuracy: 0.9652
```
...
## Epoch 2/3
## 100/100 - 0s - 863us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 812us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3351 - sparse_categorical_accuracy: 0.9048 - val_loss: 0.2134 - val_sparse_categorical_accuracy: 0.9359
```
...
```
## 4/4 - 1s - 273ms/step - loss: -1.3254e+00
```
...
## Epoch 3/20
## 625/625 - 1s - 1ms/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9623 - val_loss: 0.1291 - val_sparse_categorical_accuracy: 0.9633
## Epoch 4/20
## 625/625 - 1s - 1ms/step - loss: 0.0983 - sparse_categorical_accuracy: 0.9714 - val_loss: 0.1204 - val_sparse_categorical_accuracy: 0.9650
## Epoch 5/20
## 625/625 - 1s - 1ms/step - loss: 0.0810 - sparse_categorical_accuracy: 0.9762 - val_loss: 0.1147 - val_sparse_categorical_accuracy: 0.9658
## Epoch 6/20
## 625/625 - 1s - 1ms/step - loss: 0.0680 - sparse_categorical_accuracy: 0.9800 - val_loss: 0.1159 - val_sparse_categorical_accuracy: 0.9668
## Epoch 7/20
## 625/625 - 1s - 994us/step - loss: 0.0576 - sparse_categorical_accuracy: 0.9837 - val_loss: 0.1163 - val_sparse_categorical_accuracy: 0.9682
...
## Epoch 1/2
##
## Epoch 1: val_loss improved from inf to 0.19240, saving model to mymodel_1.keras
## 625/625 - 2s - 3ms/step - loss: 0.3761 - sparse_categorical_accuracy: 0.8939 - val_loss: 0.1924 - val_sparse_categorical_accuracy: 0.9444
## Epoch 2/2
##
## Epoch 2: val_loss improved from 0.19240 to 0.14927, saving model to mymodel_2.keras
## 625/625 - 1s - 1ms/step - loss: 0.1801 - sparse_categorical_accuracy: 0.9474 - val_loss: 0.1493 - val_sparse_categorical_accuracy: 0.9573
```
...
```
## 1563/1563 - 3s - 2ms/step - loss: 0.4822 - sparse_categorical_accuracy: 0.9119
```
