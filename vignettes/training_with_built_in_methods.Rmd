...
[guide to multi-GPU & distributed training](https://keras.io/guides/distributed_training_with_tensorflow/).
...
```
## Epoch 1/2
## 782/782 - 2s - 3ms/step - loss: 0.3482 - sparse_categorical_accuracy: 0.9005 - val_loss: 0.1974 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/2
## 782/782 - 1s - 999us/step - loss: 0.1655 - sparse_categorical_accuracy: 0.9518 - val_loss: 0.1391 - val_sparse_categorical_accuracy: 0.9606
```
...
```
## 79/79 - 0s - 5ms/step - loss: 0.1353 - sparse_categorical_accuracy: 0.9589
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.0383
```
...
```
## Epoch 1/3
## 782/782 - 2s - 2ms/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 1s - 830us/step - categorical_true_positives: 362643.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 834us/step - categorical_true_positives: 363298.0000 - loss: 0.1178
```
...
```
## 782/782 - 2s - 2ms/step - loss: 2.3949
```
...
```
## 625/625 - 2s - 3ms/step - loss: 0.3694 - sparse_categorical_accuracy: 0.8949 - val_loss: 0.1905 - val_sparse_categorical_accuracy: 0.9461
```
...
```
## Epoch 1/3
## 782/782 - 2s - 2ms/step - loss: 0.3419 - sparse_categorical_accuracy: 0.9032
## Epoch 2/3
## 782/782 - 1s - 853us/step - loss: 0.1604 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 1s - 850us/step - loss: 0.1176 - sparse_categorical_accuracy: 0.9652
```
...
```
## 157/157 - 1s - 4ms/step - loss: 0.1180 - sparse_categorical_accuracy: 0.9635
```
...
```
## Epoch 1/3
## 100/100 - 1s - 9ms/step - loss: 0.8506 - sparse_categorical_accuracy: 0.7683
## Epoch 2/3
## 100/100 - 0s - 904us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 856us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3355 - sparse_categorical_accuracy: 0.9046 - val_loss: 0.2198 - val_sparse_categorical_accuracy: 0.9313
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3350 - sparse_categorical_accuracy: 0.9049 - val_loss: 0.2111 - val_sparse_categorical_accuracy: 0.9359
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9025
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3843 - sparse_categorical_accuracy: 0.8999
```
...
```
## 4/4 - 1s - 278ms/step - loss: -1.3254e+00
```
...
## Epoch 3/20
## 625/625 - 1s - 1ms/step - loss: 0.1251 - sparse_categorical_accuracy: 0.9622 - val_loss: 0.1289 - val_sparse_categorical_accuracy: 0.9625
## Epoch 4/20
## 625/625 - 1s - 1ms/step - loss: 0.0982 - sparse_categorical_accuracy: 0.9711 - val_loss: 0.1208 - val_sparse_categorical_accuracy: 0.9648
## Epoch 5/20
## 625/625 - 1s - 1ms/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9765 - val_loss: 0.1161 - val_sparse_categorical_accuracy: 0.9666
## Epoch 6/20
## 625/625 - 1s - 1ms/step - loss: 0.0679 - sparse_categorical_accuracy: 0.9803 - val_loss: 0.1161 - val_sparse_categorical_accuracy: 0.9677
## Epoch 7/20
## 625/625 - 1s - 1ms/step - loss: 0.0577 - sparse_categorical_accuracy: 0.9839 - val_loss: 0.1170 - val_sparse_categorical_accuracy: 0.9690
## Epoch 8/20
## 625/625 - 1s - 1ms/step - loss: 0.0495 - sparse_categorical_accuracy: 0.9865 - val_loss: 0.1145 - val_sparse_categorical_accuracy: 0.9713
## Epoch 9/20
## 625/625 - 1s - 1ms/step - loss: 0.0426 - sparse_categorical_accuracy: 0.9885 - val_loss: 0.1172 - val_sparse_categorical_accuracy: 0.9721
## Epoch 10/20
## 625/625 - 1s - 1ms/step - loss: 0.0371 - sparse_categorical_accuracy: 0.9898 - val_loss: 0.1184 - val_sparse_categorical_accuracy: 0.9721
...
```
## 1563/1563 - 3s - 2ms/step - loss: 0.3681 - sparse_categorical_accuracy: 0.9146
```
