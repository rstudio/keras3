...
```
## Epoch 1/2
## 782/782 - 4s - 5ms/step - loss: 0.3482 - sparse_categorical_accuracy: 0.9005 - val_loss: 0.1974 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/2
...
## Epoch 2/2
## 782/782 - 1s - 942us/step - loss: 0.0081
```
...
## Epoch 2/3
## 782/782 - 1s - 941us/step - categorical_true_positives: 362642.0000 - loss: 0.1623
## Epoch 3/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 363341.0000 - loss: 0.1177
```
...
```
## 625/625 - 2s - 4ms/step - loss: 0.3694 - sparse_categorical_accuracy: 0.8948 - val_loss: 0.1911 - val_sparse_categorical_accuracy: 0.9453
```
...
```
## Epoch 1/3
## 782/782 - 2s - 3ms/step - loss: 0.3417 - sparse_categorical_accuracy: 0.9033
## Epoch 2/3
## 782/782 - 1s - 1ms/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9524
## Epoch 3/3
## 782/782 - 1s - 1ms/step - loss: 0.1162 - sparse_categorical_accuracy: 0.9654
```
...
```
## 157/157 - 1s - 5ms/step - loss: 0.1145 - sparse_categorical_accuracy: 0.9631
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3354 - sparse_categorical_accuracy: 0.9049 - val_loss: 0.2111 - val_sparse_categorical_accuracy: 0.9375
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
```
## 4/4 - 2s - 453ms/step - loss: -1.3254e+00
```
...
```
## Epoch 1/20
## 625/625 - 3s - 4ms/step - loss: 0.3727 - sparse_categorical_accuracy: 0.8946 - val_loss: 0.1909 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/20
## 625/625 - 1s - 1ms/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 1s - 1ms/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1294 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
...
## Epoch 5/20
## 625/625 - 1s - 1ms/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9764 - val_loss: 0.1143 - val_sparse_categorical_accuracy: 0.9667
## Epoch 6/20
## 625/625 - 1s - 1ms/step - loss: 0.0679 - sparse_categorical_accuracy: 0.9805 - val_loss: 0.1143 - val_sparse_categorical_accuracy: 0.9671
## Epoch 7/20
## 625/625 - 1s - 1ms/step - loss: 0.0579 - sparse_categorical_accuracy: 0.9838 - val_loss: 0.1193 - val_sparse_categorical_accuracy: 0.9665
## Epoch 8/20
## 625/625 - 1s - 1ms/step - loss: 0.0490 - sparse_categorical_accuracy: 0.9865 - val_loss: 0.1180 - val_sparse_categorical_accuracy: 0.9692
...
```
## 1563/1563 - 4s - 2ms/step - loss: 0.2949 - sparse_categorical_accuracy: 0.9148
```
