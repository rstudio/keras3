...
date: 'Last Modified: 2023-11-29; Last Rendered: 2023-12-04'
vignette: >
...
## Epoch 2/2
## 782/782 - 1s - 886us/step - loss: 0.1651 - sparse_categorical_accuracy: 0.9520 - val_loss: 0.1389 - val_sparse_categorical_accuracy: 0.9598
```
...
##                            loss: 0.1651
##     sparse_categorical_accuracy: 0.952
##                        val_loss: 0.1389
## val_sparse_categorical_accuracy: 0.9598
```
...
```
## 79/79 - 0s - 529us/step - loss: 0.1344 - sparse_categorical_accuracy: 0.9591
```
...
##   export_savedmodel.keras.models.model.Model                 keras3
...
```r
CategoricalTruePositives <- new_metric_class(
...
model %>% compile(
    optimizer = optimizer_rmsprop(learning_rate=1e-3),
    loss = loss_sparse_categorical_crossentropy(),
    metrics = list(CategoricalTruePositives())
)
...
```
## Epoch 1/3
## 782/782 - 1s - 968us/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 1s - 640us/step - categorical_true_positives: 362661.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 655us/step - categorical_true_positives: 363312.0000 - loss: 0.1176
```
...
```
## 782/782 - 1s - 889us/step - loss: 2.3949
```
...
```r
LogisticEndpoint <- new_layer_class(
  "LogisticEndpoint",
...
```
## 625/625 - 1s - 1ms/step - loss: 0.3694 - sparse_categorical_accuracy: 0.8948 - val_loss: 0.1911 - val_sparse_categorical_accuracy: 0.9453
```
...
```
## Epoch 1/3
## 782/782 - 1s - 1ms/step - loss: 0.3417 - sparse_categorical_accuracy: 0.9033
## Epoch 2/3
## 782/782 - 1s - 666us/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9524
## Epoch 3/3
## 782/782 - 1s - 660us/step - loss: 0.1162 - sparse_categorical_accuracy: 0.9654
```
...
```
## 157/157 - 0s - 1ms/step - loss: 0.1145 - sparse_categorical_accuracy: 0.9631
```
...
```
## Epoch 1/3
## 100/100 - 0s - 4ms/step - loss: 0.8506 - sparse_categorical_accuracy: 0.7683
## Epoch 2/3
## 100/100 - 0s - 653us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 662us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 1s - 1ms/step - loss: 0.3355 - sparse_categorical_accuracy: 0.9047 - val_loss: 0.2198 - val_sparse_categorical_accuracy: 0.9320
```
...
```
## 782/782 - 1s - 976us/step - loss: 0.3687 - sparse_categorical_accuracy: 0.9026
```
...
```
## 782/782 - 1s - 984us/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
![plot of chunk unnamed-chunk-26](/Users/dfalbel/Documents/posit/keras/man/figures/training_with_built_in_methods/unnamed-chunk-26-1.png)
...
```
## 4/4 - 0s - 62ms/step - loss: -1.3254e+00
```
...
## Epoch 2/20
## 625/625 - 0s - 752us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 0s - 780us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1294 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
## 625/625 - 0s - 764us/step - loss: 0.0984 - sparse_categorical_accuracy: 0.9707 - val_loss: 0.1213 - val_sparse_categorical_accuracy: 0.9647
## Epoch 5/20
## 625/625 - 0s - 750us/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9763 - val_loss: 0.1146 - val_sparse_categorical_accuracy: 0.9669
## Epoch 6/20
## 625/625 - 0s - 751us/step - loss: 0.0680 - sparse_categorical_accuracy: 0.9808 - val_loss: 0.1144 - val_sparse_categorical_accuracy: 0.9679
## Epoch 7/20
## 625/625 - 0s - 750us/step - loss: 0.0576 - sparse_categorical_accuracy: 0.9838 - val_loss: 0.1172 - val_sparse_categorical_accuracy: 0.9677
## Epoch 8/20
## 625/625 - 0s - 740us/step - loss: 0.0492 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1165 - val_sparse_categorical_accuracy: 0.9707
...
## 625/625 - 0s - 779us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9468 - val_loss: 0.1491 - val_sparse_categorical_accuracy: 0.9572
```
...
```
## Error in load_model(latest_checkpoint): could not find function "load_model"
```
...
```
## 1563/1563 - 1s - 708us/step - loss: 0.1357 - sparse_categorical_accuracy: 0.9597
```
