...
date: 'Last Modified: 2023-12-21; Last Rendered: 2024-01-03'
vignette: >
...
## Epoch 2/2
## 782/782 - 1s - 748us/step - loss: 0.1651 - sparse_categorical_accuracy: 0.9519 - val_loss: 0.1387 - val_sparse_categorical_accuracy: 0.9602
```
...
```
## 79/79 - 0s - 514us/step - loss: 0.1347 - sparse_categorical_accuracy: 0.9591
```
...
```
## Epoch 1/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 1s - 649us/step - categorical_true_positives: 362643.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 654us/step - categorical_true_positives: 363298.0000 - loss: 0.1178
```
...
```
## 782/782 - 1s - 864us/step - loss: 2.3949
```
...
## Epoch 2/3
## 782/782 - 1s - 670us/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9524
## Epoch 3/3
## 782/782 - 1s - 641us/step - loss: 0.1162 - sparse_categorical_accuracy: 0.9654
```
...
```
## 157/157 - 0s - 751us/step - loss: 0.1145 - sparse_categorical_accuracy: 0.9631
```
...
## Epoch 2/3
## 100/100 - 0s - 722us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 731us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 1s - 1ms/step - loss: 0.3687 - sparse_categorical_accuracy: 0.9026
```
...
```
## 782/782 - 1s - 998us/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
```
## 4/4 - 0s - 58ms/step - loss: -1.3254e+00
```
...
## Epoch 2/20
## 625/625 - 0s - 765us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 0s - 763us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1289 - val_sparse_categorical_accuracy: 0.9623
## Epoch 4/20
## 625/625 - 0s - 759us/step - loss: 0.0983 - sparse_categorical_accuracy: 0.9710 - val_loss: 0.1205 - val_sparse_categorical_accuracy: 0.9651
## Epoch 5/20
## 625/625 - 0s - 763us/step - loss: 0.0808 - sparse_categorical_accuracy: 0.9765 - val_loss: 0.1157 - val_sparse_categorical_accuracy: 0.9659
## Epoch 6/20
## 625/625 - 0s - 754us/step - loss: 0.0679 - sparse_categorical_accuracy: 0.9801 - val_loss: 0.1145 - val_sparse_categorical_accuracy: 0.9684
## Epoch 7/20
## 625/625 - 0s - 760us/step - loss: 0.0574 - sparse_categorical_accuracy: 0.9840 - val_loss: 0.1140 - val_sparse_categorical_accuracy: 0.9701
## Epoch 8/20
## 625/625 - 0s - 768us/step - loss: 0.0492 - sparse_categorical_accuracy: 0.9864 - val_loss: 0.1134 - val_sparse_categorical_accuracy: 0.9710
## Epoch 9/20
## 625/625 - 0s - 748us/step - loss: 0.0427 - sparse_categorical_accuracy: 0.9882 - val_loss: 0.1156 - val_sparse_categorical_accuracy: 0.9717
## Epoch 10/20
## 625/625 - 0s - 752us/step - loss: 0.0372 - sparse_categorical_accuracy: 0.9898 - val_loss: 0.1186 - val_sparse_categorical_accuracy: 0.9725
...
## 625/625 - 0s - 775us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9468 - val_loss: 0.1491 - val_sparse_categorical_accuracy: 0.9572
```
...
```
## 1563/1563 - 1s - 781us/step - loss: 0.2470 - sparse_categorical_accuracy: 0.9270
```
