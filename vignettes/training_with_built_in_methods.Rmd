...
date: 'Last Modified: 2023-11-29; Last Rendered: 2023-12-05'
vignette: >
...
## Epoch 2/2
## 782/782 - 1s - 827us/step - loss: 0.1651 - sparse_categorical_accuracy: 0.9520 - val_loss: 0.1389 - val_sparse_categorical_accuracy: 0.9598
```
...
```
## 79/79 - 0s - 589us/step - loss: 0.1344 - sparse_categorical_accuracy: 0.9591
```
...
```
## Epoch 1/3
## 782/782 - 1s - 942us/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 1s - 768us/step - categorical_true_positives: 362661.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 738us/step - categorical_true_positives: 363312.0000 - loss: 0.1176
```
...
```
## 782/782 - 1s - 828us/step - loss: 2.3949
```
...
## Epoch 2/3
## 782/782 - 1s - 722us/step - loss: 0.1602 - sparse_categorical_accuracy: 0.9524
## Epoch 3/3
## 782/782 - 1s - 721us/step - loss: 0.1162 - sparse_categorical_accuracy: 0.9654
```
...
```
## 157/157 - 0s - 717us/step - loss: 0.1145 - sparse_categorical_accuracy: 0.9631
```
...
## Epoch 2/3
## 100/100 - 0s - 693us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 722us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 1s - 936us/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
```
## 4/4 - 0s - 48ms/step - loss: -1.3254e+00
```
...
## Epoch 2/20
## 625/625 - 1s - 863us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1441 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 1s - 952us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1294 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
## 625/625 - 1s - 1ms/step - loss: 0.0984 - sparse_categorical_accuracy: 0.9707 - val_loss: 0.1213 - val_sparse_categorical_accuracy: 0.9647
## Epoch 5/20
## 625/625 - 1s - 836us/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9763 - val_loss: 0.1146 - val_sparse_categorical_accuracy: 0.9669
## Epoch 6/20
## 625/625 - 1s - 840us/step - loss: 0.0680 - sparse_categorical_accuracy: 0.9808 - val_loss: 0.1144 - val_sparse_categorical_accuracy: 0.9679
## Epoch 7/20
## 625/625 - 1s - 889us/step - loss: 0.0576 - sparse_categorical_accuracy: 0.9838 - val_loss: 0.1172 - val_sparse_categorical_accuracy: 0.9677
## Epoch 8/20
## 625/625 - 1s - 867us/step - loss: 0.0492 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1165 - val_sparse_categorical_accuracy: 0.9707
...
## 625/625 - 1s - 828us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9468 - val_loss: 0.1491 - val_sparse_categorical_accuracy: 0.9572
```
...
```
## 1563/1563 - 1s - 819us/step - loss: 0.2421 - sparse_categorical_accuracy: 0.9284
```
