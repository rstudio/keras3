...
```
## Epoch 1/2
## 782/782 - 2s - 3ms/step - loss: 0.3483 - sparse_categorical_accuracy: 0.9004 - val_loss: 0.1972 - val_sparse_categorical_accuracy: 0.9444
## Epoch 2/2
## 782/782 - 1s - 787us/step - loss: 0.1652 - sparse_categorical_accuracy: 0.9519 - val_loss: 0.1393 - val_sparse_categorical_accuracy: 0.9602
```
...
```
## 79/79 - 0s - 3ms/step - loss: 0.1356 - sparse_categorical_accuracy: 0.9591
```
...
## Epoch 2/2
## 782/782 - 1s - 653us/step - loss: 0.0081
```
...
```
## Epoch 1/3
## 782/782 - 1s - 2ms/step - categorical_true_positives: 360544.0000 - loss: 0.3423
## Epoch 2/3
## 782/782 - 1s - 673us/step - categorical_true_positives: 362642.0000 - loss: 0.1624
## Epoch 3/3
## 782/782 - 1s - 664us/step - categorical_true_positives: 363341.0000 - loss: 0.1177
```
...
```
## 782/782 - 1s - 2ms/step - loss: 2.3950
```
...
```
## 625/625 - 1s - 2ms/step - loss: 0.3694 - sparse_categorical_accuracy: 0.8948 - val_loss: 0.1919 - val_sparse_categorical_accuracy: 0.9453
```
...
```
## Epoch 1/3
## 782/782 - 2s - 2ms/step - loss: 0.3420 - sparse_categorical_accuracy: 0.9033
## Epoch 2/3
## 782/782 - 1s - 673us/step - loss: 0.1599 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 1s - 659us/step - loss: 0.1166 - sparse_categorical_accuracy: 0.9655
```
...
```
## 157/157 - 0s - 3ms/step - loss: 0.1142 - sparse_categorical_accuracy: 0.9635
```
...
## Epoch 2/3
## 100/100 - 0s - 702us/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 681us/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3358 - sparse_categorical_accuracy: 0.9046 - val_loss: 0.2208 - val_sparse_categorical_accuracy: 0.9313
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3356 - sparse_categorical_accuracy: 0.9049 - val_loss: 0.2111 - val_sparse_categorical_accuracy: 0.9375
```
...
```
## 782/782 - 1s - 2ms/step - loss: 0.3689 - sparse_categorical_accuracy: 0.9026
```
...
```
## 782/782 - 1s - 2ms/step - loss: 0.3687 - sparse_categorical_accuracy: 0.9024
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3846 - sparse_categorical_accuracy: 0.8999
```
...
```
## Epoch 1/20
## 625/625 - 1s - 2ms/step - loss: 0.3727 - sparse_categorical_accuracy: 0.8946 - val_loss: 0.1916 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/20
## 625/625 - 1s - 843us/step - loss: 0.1740 - sparse_categorical_accuracy: 0.9485 - val_loss: 0.1446 - val_sparse_categorical_accuracy: 0.9572
## Epoch 3/20
## 625/625 - 1s - 847us/step - loss: 0.1252 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1299 - val_sparse_categorical_accuracy: 0.9619
## Epoch 4/20
## 625/625 - 1s - 852us/step - loss: 0.0984 - sparse_categorical_accuracy: 0.9707 - val_loss: 0.1218 - val_sparse_categorical_accuracy: 0.9647
## Epoch 5/20
## 625/625 - 1s - 836us/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9762 - val_loss: 0.1158 - val_sparse_categorical_accuracy: 0.9667
## Epoch 6/20
## 625/625 - 1s - 830us/step - loss: 0.0683 - sparse_categorical_accuracy: 0.9803 - val_loss: 0.1147 - val_sparse_categorical_accuracy: 0.9680
## Epoch 7/20
## 625/625 - 1s - 850us/step - loss: 0.0578 - sparse_categorical_accuracy: 0.9835 - val_loss: 0.1147 - val_sparse_categorical_accuracy: 0.9694
## Epoch 8/20
## 625/625 - 1s - 847us/step - loss: 0.0493 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1161 - val_sparse_categorical_accuracy: 0.9708
## Epoch 9/20
## 625/625 - 1s - 849us/step - loss: 0.0423 - sparse_categorical_accuracy: 0.9882 - val_loss: 0.1180 - val_sparse_categorical_accuracy: 0.9716
...
## Epoch 1/2
##
## Epoch 1: val_loss improved from inf to 0.19386, saving model to mymodel_1.keras
## 625/625 - 1s - 2ms/step - loss: 0.3759 - sparse_categorical_accuracy: 0.8940 - val_loss: 0.1939 - val_sparse_categorical_accuracy: 0.9447
## Epoch 2/2
##
## Epoch 2: val_loss improved from 0.19386 to 0.14994, saving model to mymodel_2.keras
## 625/625 - 1s - 858us/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9469 - val_loss: 0.1499 - val_sparse_categorical_accuracy: 0.9576
```
