...
## Epoch 2/2
## 782/782 - 1s - 2ms/step - loss: 0.1590 - sparse_categorical_accuracy: 0.9538 - val_loss: 0.1323 - val_sparse_categorical_accuracy: 0.9621
```
...
## Epoch 2/2
## 782/782 - 1s - 982us/step - loss: 0.0078
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.0390
```
...
```
## Epoch 1/3
## 782/782 - 2s - 2ms/step - categorical_true_positives: 360514.0000 - loss: 0.3444
## Epoch 2/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 362540.0000 - loss: 0.1654
## Epoch 3/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 363195.0000 - loss: 0.1199
```
...
```
## 625/625 - 2s - 3ms/step - loss: 0.3817 - sparse_categorical_accuracy: 0.8919 - val_loss: 0.1957 - val_sparse_categorical_accuracy: 0.9430
```
...
## Epoch 2/3
## 782/782 - 1s - 944us/step - loss: 0.1606 - sparse_categorical_accuracy: 0.9521
## Epoch 3/3
## 782/782 - 1s - 1000us/step - loss: 0.1178 - sparse_categorical_accuracy: 0.9646
```
...
## Epoch 2/3
## 100/100 - 0s - 996us/step - loss: 0.3661 - sparse_categorical_accuracy: 0.9006
## Epoch 3/3
## 100/100 - 0s - 942us/step - loss: 0.3009 - sparse_categorical_accuracy: 0.9106
```
...
```
## 782/782 - 3s - 3ms/step - loss: 0.3391 - sparse_categorical_accuracy: 0.9035 - val_loss: 0.1997 - val_sparse_categorical_accuracy: 0.9391
```
...
```
## 782/782 - 1s - 2ms/step - loss: 0.3735 - sparse_categorical_accuracy: 0.9018
```
...
```
## 4/4 - 2s - 509ms/step - class_output_categorical_accuracy: 0.2300 - class_output_loss: 1.8162 - loss: 3.8764 - score_output_loss: 1.6820 - score_output_mean_absolute_error: 0.8826 - score_output_mean_absolute_percentage_error: 1826.5676
```
...
```
## 4/4 - 2s - 415ms/step - class_output_loss: 4.1489 - loss: 4.5443 - score_output_loss: -4.1125e-01
```
...
```
## 2/2 - 1s - 712ms/step - class_output_loss: 3.8547 - loss: 3.5725 - score_output_loss: -1.5209e-01
```
...
```
## Epoch 1/20
## 625/625 - 2s - 3ms/step - loss: 0.3695 - sparse_categorical_accuracy: 0.8961 - val_loss: 0.1877 - val_sparse_categorical_accuracy: 0.9472
## Epoch 2/20
## 625/625 - 1s - 2ms/step - loss: 0.1752 - sparse_categorical_accuracy: 0.9486 - val_loss: 0.1414 - val_sparse_categorical_accuracy: 0.9570
## Epoch 3/20
## 625/625 - 1s - 1ms/step - loss: 0.1280 - sparse_categorical_accuracy: 0.9623 - val_loss: 0.1215 - val_sparse_categorical_accuracy: 0.9644
## Epoch 4/20
## 625/625 - 1s - 1ms/step - loss: 0.1009 - sparse_categorical_accuracy: 0.9700 - val_loss: 0.1126 - val_sparse_categorical_accuracy: 0.9667
## Epoch 5/20
## 625/625 - 1s - 1ms/step - loss: 0.0817 - sparse_categorical_accuracy: 0.9757 - val_loss: 0.1084 - val_sparse_categorical_accuracy: 0.9682
## Epoch 6/20
## 625/625 - 1s - 1ms/step - loss: 0.0680 - sparse_categorical_accuracy: 0.9802 - val_loss: 0.1074 - val_sparse_categorical_accuracy: 0.9700
## Epoch 7/20
## 625/625 - 1s - 1ms/step - loss: 0.0569 - sparse_categorical_accuracy: 0.9837 - val_loss: 0.1114 - val_sparse_categorical_accuracy: 0.9693
## Epoch 8/20
## 625/625 - 1s - 1ms/step - loss: 0.0480 - sparse_categorical_accuracy: 0.9863 - val_loss: 0.1124 - val_sparse_categorical_accuracy: 0.9700
...
## Epoch 2/2
##
## Epoch 2: val_loss improved from 0.19344 to 0.14244, saving model to mymodel_2.keras
## 625/625 - 1s - 1ms/step - loss: 0.1768 - sparse_categorical_accuracy: 0.9479 - val_loss: 0.1424 - val_sparse_categorical_accuracy: 0.9597
```
