...
```
## Epoch 1/2
## 782/782 - 3s - 4ms/step - loss: 0.3482 - sparse_categorical_accuracy: 0.9005 - val_loss: 0.1974 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/2
## 782/782 - 1s - 1ms/step - loss: 0.1655 - sparse_categorical_accuracy: 0.9518 - val_loss: 0.1391 - val_sparse_categorical_accuracy: 0.9606
```
...
```
## 79/79 - 0s - 6ms/step - loss: 0.1353 - sparse_categorical_accuracy: 0.9589
```
...
```
## 782/782 - 3s - 3ms/step - loss: 0.0157
```
...
```
## 782/782 - 3s - 3ms/step - loss: 0.0383
```
...
```
## Epoch 1/3
## 782/782 - 2s - 3ms/step - categorical_true_positives: 360544.0000 - loss: 0.3421
## Epoch 2/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 362643.0000 - loss: 0.1622
## Epoch 3/3
## 782/782 - 1s - 1ms/step - categorical_true_positives: 363298.0000 - loss: 0.1178
```
...
```
## 782/782 - 2s - 3ms/step - loss: 2.3949
```
...
```
## 625/625 - 2s - 3ms/step - loss: 0.3694 - sparse_categorical_accuracy: 0.8948 - val_loss: 0.1911 - val_sparse_categorical_accuracy: 0.9453
```
...
```
## Epoch 1/3
## 782/782 - 2s - 3ms/step - loss: 0.3419 - sparse_categorical_accuracy: 0.9032
## Epoch 2/3
## 782/782 - 1s - 1ms/step - loss: 0.1604 - sparse_categorical_accuracy: 0.9525
## Epoch 3/3
## 782/782 - 1s - 1ms/step - loss: 0.1176 - sparse_categorical_accuracy: 0.9652
```
...
```
## 157/157 - 1s - 5ms/step - loss: 0.1180 - sparse_categorical_accuracy: 0.9635
```
...
```
## Epoch 1/3
## 100/100 - 1s - 11ms/step - loss: 0.8506 - sparse_categorical_accuracy: 0.7683
## Epoch 2/3
## 100/100 - 0s - 1ms/step - loss: 0.3705 - sparse_categorical_accuracy: 0.8947
## Epoch 3/3
## 100/100 - 0s - 1ms/step - loss: 0.3060 - sparse_categorical_accuracy: 0.9130
```
...
```
## 782/782 - 3s - 3ms/step - loss: 0.3355 - sparse_categorical_accuracy: 0.9046 - val_loss: 0.2198 - val_sparse_categorical_accuracy: 0.9313
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3351 - sparse_categorical_accuracy: 0.9048 - val_loss: 0.2134 - val_sparse_categorical_accuracy: 0.9359
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3687 - sparse_categorical_accuracy: 0.9026
```
...
```
## 782/782 - 2s - 2ms/step - loss: 0.3685 - sparse_categorical_accuracy: 0.9024
```
...
```
## 782/782 - 2s - 3ms/step - loss: 0.3843 - sparse_categorical_accuracy: 0.8999
```
...
<div class="figure">
<img src="training_with_built_in_methods/unnamed-chunk-26-1.png" alt="plot of chunk unnamed-chunk-26" width="744" />
...
```
## 4/4 - 1s - 317ms/step - loss: -1.3254e+00
```
...
```
## Epoch 1/20
## 625/625 - 2s - 3ms/step - loss: 0.3727 - sparse_categorical_accuracy: 0.8946 - val_loss: 0.1909 - val_sparse_categorical_accuracy: 0.9440
## Epoch 2/20
## 625/625 - 1s - 1ms/step - loss: 0.1741 - sparse_categorical_accuracy: 0.9484 - val_loss: 0.1431 - val_sparse_categorical_accuracy: 0.9580
## Epoch 3/20
## 625/625 - 1s - 1ms/step - loss: 0.1251 - sparse_categorical_accuracy: 0.9626 - val_loss: 0.1292 - val_sparse_categorical_accuracy: 0.9625
## Epoch 4/20
## 625/625 - 1s - 1ms/step - loss: 0.0982 - sparse_categorical_accuracy: 0.9709 - val_loss: 0.1206 - val_sparse_categorical_accuracy: 0.9650
## Epoch 5/20
## 625/625 - 1s - 1ms/step - loss: 0.0809 - sparse_categorical_accuracy: 0.9767 - val_loss: 0.1165 - val_sparse_categorical_accuracy: 0.9657
## Epoch 6/20
## 625/625 - 1s - 1ms/step - loss: 0.0681 - sparse_categorical_accuracy: 0.9804 - val_loss: 0.1172 - val_sparse_categorical_accuracy: 0.9671
## Epoch 7/20
## 625/625 - 1s - 1ms/step - loss: 0.0577 - sparse_categorical_accuracy: 0.9839 - val_loss: 0.1163 - val_sparse_categorical_accuracy: 0.9683
## Epoch 8/20
## 625/625 - 1s - 1ms/step - loss: 0.0494 - sparse_categorical_accuracy: 0.9861 - val_loss: 0.1155 - val_sparse_categorical_accuracy: 0.9703
## Epoch 9/20
## 625/625 - 1s - 1ms/step - loss: 0.0425 - sparse_categorical_accuracy: 0.9880 - val_loss: 0.1149 - val_sparse_categorical_accuracy: 0.9721
## Epoch 10/20
## 625/625 - 1s - 1ms/step - loss: 0.0371 - sparse_categorical_accuracy: 0.9899 - val_loss: 0.1180 - val_sparse_categorical_accuracy: 0.9724
## Epoch 11/20
## 625/625 - 1s - 1ms/step - loss: 0.0322 - sparse_categorical_accuracy: 0.9916 - val_loss: 0.1209 - val_sparse_categorical_accuracy: 0.9733
...
## 625/625 - 2s - 3ms/step - loss: 0.3759 - sparse_categorical_accuracy: 0.8940 - val_loss: 0.1932 - val_sparse_categorical_accuracy: 0.9447
## Epoch 2/2
##
## Epoch 2: val_loss improved from 0.19317 to 0.14907, saving model to mymodel_2.keras
## 625/625 - 1s - 1ms/step - loss: 0.1797 - sparse_categorical_accuracy: 0.9468 - val_loss: 0.1491 - val_sparse_categorical_accuracy: 0.9572
```
...
```
## 1563/1563 - 3s - 2ms/step - loss: 0.4025 - sparse_categorical_accuracy: 0.9177
```
