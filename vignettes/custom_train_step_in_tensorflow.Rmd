...
```
## Epoch 1/3
## 32/32 - 1s - 33ms/step - loss: 2.9118 - mae: 1.3597
## Epoch 2/3
## 32/32 - 0s - 2ms/step - loss: 2.6026 - mae: 1.2856
## Epoch 3/3
...
```
## Epoch 1/3
## 32/32 - 1s - 24ms/step - loss: 2.6540 - mae: 1.2901
## Epoch 2/3
...
```
## Epoch 1/3
## 32/32 - 1s - 26ms/step - loss: 0.1607 - mae: 1.3018
## Epoch 2/3
...
```
## 32/32 - 0s - 11ms/step - loss: 0.0000e+00 - mae: 1.3947
```
...
```
## <keras.src.losses.losses.BinaryCrossentropy object at 0x7fe800716c10>
```
...
```
## 100/100 - 7s - 66ms/step - d_loss: 0.0000e+00 - g_loss: 0.0000e+00
```
