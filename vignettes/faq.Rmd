...
Finally, you can freeze or unfreeze and entire model (or a range of layers within the model) using the `freeze_layers()` and `unfreeze_layers()` functions. For example:
