...
By default the Keras Python and R packages use the TensorFlow backend. This is the backend used for development and testing of the R package and is therefore strongly recommended unless you have specific requirements better met by other backends. 

To learn more about using alternatate backends (e.g. Theano or CNTK) see the [article on  Keras backends](backends.html).
