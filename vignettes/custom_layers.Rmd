...
The example below illustrates the skeleton of a Keras custom layer. The [mnist_antirectifier](https://rstudio.github.io/keras/articles/examples/mnist_antirectifier.html) example includes another demonstration of creating a custom layer.
...
See the [mnist_antirectifier](https://rstudio.github.io/keras/articles/examples/mnist_antirectifier.html) example for another demonstration of creating a custom layer.
