...
The core data structure of Keras is a model, a way to organize layers. The simplest type of model is the [Sequential model](https://tensorflow.rstudio.com/guides/keras/sequential_model), a linear stack of layers.
