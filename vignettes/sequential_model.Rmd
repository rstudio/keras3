...
- [IMDB movie review sentiment classification](https://tensorflow.rstudio.com/examples/imdb_cnn_lstm) 

- [Reuters newswires topic classification](https://tensorflow.rstudio.com/examples/reuters_mlp) 

- [MNIST handwritten digits classification](https://tensorflow.rstudio.com/examples/mnist_mlp)

- [Character-level text generation with LSTM](https://tensorflow.rstudio.com/examples/lstm_text_generation)
