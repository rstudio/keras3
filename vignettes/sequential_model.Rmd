...
On the [examples](https://tensorflow.rstudio.com/guide/keras/examples/) page you will also find example models for real datasets:
...
[You can read more about stateful RNNs in the FAQ.](https://tensorflow.rstudio.com/articles/faq.html#how-can-i-use-stateful-rnns)
