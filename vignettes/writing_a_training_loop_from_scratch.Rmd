...
## Start of epoch  2
## Training loss (for one batch) at step 200: 0.8043
## Seen so far: 12800 samples
## Training loss (for one batch) at step 400: 0.6765
## Seen so far: 25600 samples
## Training loss (for one batch) at step 600: 0.5626
## Seen so far: 38400 samples
## Training acc over epoch: 0.8019
## Validation acc: 0.8122
```
...
```
## Time difference of 10.65904 secs
```
...
```
## Start of epoch  1
## Training loss (for one batch) at step 200: 0.8536
## Seen so far: 12800 samples
## Training loss (for one batch) at step 400: 0.8536
## Seen so far: 25600 samples
## Training loss (for one batch) at step 600: 0.8536
## Seen so far: 38400 samples
...
## Training loss (for one batch) at step 600: 0.8536
## Seen so far: 38400 samples
## Training acc over epoch: 0.8652
...
```
## Time difference of 1.309618 secs
```
