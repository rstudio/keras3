...
```
## 146/146 - 41s - 284ms/step - binary_accuracy: 0.9104 - loss: 0.1956 - val_binary_accuracy: 0.9673 - val_loss: 0.0918
```
...
```
## 146/146 - 87s - 597ms/step - binary_accuracy: 0.8710 - loss: 0.3235 - val_binary_accuracy: 0.9617 - val_loss: 0.1073
```
...
```
## 37/37 - 2s - 41ms/step - binary_accuracy: 0.9557 - loss: 0.1094
```
