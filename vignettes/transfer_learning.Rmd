...
![plot of chunk unnamed-chunk-13](/Users/dfalbel/Documents/posit/keras/man/figures/transfer_learning/unnamed-chunk-13-1.png)
...
![plot of chunk unnamed-chunk-17](/Users/dfalbel/Documents/posit/keras/man/figures/transfer_learning/unnamed-chunk-17-1.png)
...
## ├──────────────────────────┼────────────────────────┼────────┼──────┤
## │ xception (Functional)    │ (None, 5, 5, 2048)     │ 20,86… │  N   │
## ├──────────────────────────┼────────────────────────┼────────┼──────┤
## │ global_average_pooling2… │ (None, 2048)           │      0 │  -   │
...
```
## 146/146 - 103s - 705ms/step - binary_accuracy: 0.9125 - loss: 0.1910 - val_binary_accuracy: 0.9700 - val_loss: 0.0886
```
...
## │ rescaling (Rescaling)    │ (None, 150, 150, 3)    │      0 │  -   │
## ├──────────────────────────┼────────────────────────┼────────┼──────┤
## │ xception (Functional)    │ (None, 5, 5, 2048)     │ 20,86… │  Y   │
## ├──────────────────────────┼────────────────────────┼────────┼──────┤
## │ global_average_pooling2… │ (None, 2048)           │      0 │  -   │
## │ (GlobalAveragePooling2D) │                        │        │      │
## ├──────────────────────────┼────────────────────────┼────────┼──────┤
...
```
## 146/146 - 422s - 3s/step - binary_accuracy: 0.8602 - loss: 0.3427 - val_binary_accuracy: 0.9456 - val_loss: 0.1240
```
...
```
## 37/37 - 20s - 546ms/step - binary_accuracy: 0.9413 - loss: 0.1453
```
