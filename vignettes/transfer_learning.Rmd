...
![plot of chunk unnamed-chunk-13](transfer_learning/unnamed-chunk-13-1.png)
...
![plot of chunk unnamed-chunk-17](transfer_learning/unnamed-chunk-17-1.png)
...
```
## 146/146 - 55s - 374ms/step - binary_accuracy: 0.9106 - loss: 0.1951 - val_binary_accuracy: 0.9679 - val_loss: 0.0913
```
...
```
## 146/146 - 80s - 545ms/step - binary_accuracy: 0.8583 - loss: 0.3436 - val_binary_accuracy: 0.9443 - val_loss: 0.1300
```
...
```
## 37/37 - 1s - 39ms/step - binary_accuracy: 0.9367 - loss: 0.1493
```
