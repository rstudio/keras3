...
[Deep Learning with R](https://www.manning.com/books/deep-learning-with-r-third-edition)
...
```
## 146/146 - 58s - 396ms/step - binary_accuracy: 0.9183 - loss: 0.1887 - val_binary_accuracy: 0.9669 - val_loss: 0.0926
```
...
```
## 146/146 - 88s - 606ms/step - binary_accuracy: 0.8660 - loss: 0.3213 - val_binary_accuracy: 0.9652 - val_loss: 0.1022
```
