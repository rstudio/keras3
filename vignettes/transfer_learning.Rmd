...
```
## 146/146 - 66s - 454ms/step - binary_accuracy: 0.9106 - loss: 0.1951 - val_binary_accuracy: 0.9679 - val_loss: 0.0913
```
...
```
## 146/146 - 86s - 591ms/step - binary_accuracy: 0.8583 - loss: 0.3436 - val_binary_accuracy: 0.9443 - val_loss: 0.1300
```
...
```
## 37/37 - 2s - 43ms/step - binary_accuracy: 0.9367 - loss: 0.1492
```
