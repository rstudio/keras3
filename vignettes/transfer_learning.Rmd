...
```
## 146/146 - 63s - 430ms/step - binary_accuracy: 0.9106 - loss: 0.1951 - val_binary_accuracy: 0.9679 - val_loss: 0.0913
```
...
```
## 146/146 - 96s - 659ms/step - binary_accuracy: 0.8582 - loss: 0.3436 - val_binary_accuracy: 0.9443 - val_loss: 0.1300
```
...
```
## 37/37 - 2s - 45ms/step - binary_accuracy: 0.9367 - loss: 0.1492
```
