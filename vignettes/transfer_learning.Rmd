...
```
## 146/146 - 66s - 449ms/step - binary_accuracy: 0.9106 - loss: 0.1951 - val_binary_accuracy: 0.9679 - val_loss: 0.0913
```
...
```
## 146/146 - 91s - 624ms/step - binary_accuracy: 0.8583 - loss: 0.3436 - val_binary_accuracy: 0.9443 - val_loss: 0.1300
```
...
```
## 37/37 - 2s - 42ms/step - binary_accuracy: 0.9367 - loss: 0.1492
```
