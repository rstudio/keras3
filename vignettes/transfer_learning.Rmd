...
```
## 146/146 - 55s - 376ms/step - binary_accuracy: 0.9106 - loss: 0.1951 - val_binary_accuracy: 0.9679 - val_loss: 0.0913
```
...
```
## 146/146 - 81s - 556ms/step - binary_accuracy: 0.8582 - loss: 0.3436 - val_binary_accuracy: 0.9443 - val_loss: 0.1300
```
...
```
## 37/37 - 1s - 40ms/step - binary_accuracy: 0.9371 - loss: 0.1492
```
