...
You should either use a distinct log directory for each training run or remove the log directory between runs. You can use the `unique_dir` function to easily create a directory per-run:
