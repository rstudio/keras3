...
This guide assumes that you are already familiar with the [Sequential](https://tensorflow.rstudio.com/guides/keras/sequential_model) model.

Let's start with something simple.

## First example: a densely-connected network

The [Sequential](https://tensorflow.rstudio.com/guides/keras/sequential_model) model is probably a better choice to implement such a network, but it helps to start with something really simple.
...
Note that Keras objects are [modified in place](https://tensorflow.rstudio.com/guides/keras/basics) which is why it's not necessary for `model` to be assigned back to after it is compiled.
