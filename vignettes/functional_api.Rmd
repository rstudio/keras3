...
date: 'Last Modified: 2023-11-29; Last Rendered: 2023-12-22'
vignette: >
...
![plot of chunk unnamed-chunk-10](/Users/tomasz/github/rstudio/keras/man/figures/functional_api/unnamed-chunk-10-1.png)
...
![plot of chunk unnamed-chunk-11](/Users/tomasz/github/rstudio/keras/man/figures/functional_api/unnamed-chunk-11-1.png)
...
```
## Epoch 1/2
## 750/750 - 1s - 1ms/step - accuracy: 0.9015 - loss: 0.3513 - val_accuracy: 0.9442 - val_loss: 0.1921
## Epoch 2/2
## 750/750 - 1s - 839us/step - accuracy: 0.9508 - loss: 0.1643 - val_accuracy: 0.9581 - val_loss: 0.1423
```
...
```
## 313/313 - 0s - 355us/step - accuracy: 0.9578 - loss: 0.1338
```
...
```
## Error in cat("Test loss:", test_scores["loss"]): argument 2 (type 'list') cannot be handled by 'cat'
```

```r
cat("Test accuracy:", test_scores["compile_metrics"])
```
...
```
## Error in cat("Test accuracy:", test_scores["compile_metrics"]): argument 2 (type 'list') cannot be handled by 'cat'
```
...
autoencoder = keras_model(autoencoder_input, decoded_img, name="autoencoder")
summary(autoencoder)
```
...
![plot of chunk unnamed-chunk-18](/Users/tomasz/github/rstudio/keras/man/figures/functional_api/unnamed-chunk-18-1.png)
...
```
## Epoch 1/2
## 40/40 - 2s - 58ms/step - loss: 0.3948
## Epoch 2/2
## 40/40 - 1s - 16ms/step - loss: 0.1971
```
...
## ├───────────────────────┼───────────────────┼──────────┼───────────────────────┤
## │ conv2d_11 ([38;5;33mConv2D[0m)    │ ([38;5;45mNone[0m, [38;5;34m9[0m, [38;5;34m9[0m, [38;5;34m32[0m)  │   [38;5;34m18,464[0m │ max_pooling2d_2[[38;5;34m0[0m][[38;5;34m0[0m] │
## ├───────────────────────┼───────────────────┼──────────┼───────────────────────┤
...
## ├───────────────────────┼───────────────────┼──────────┼───────────────────────┤
## │ global_average_pooli… │ ([38;5;45mNone[0m, [38;5;34m64[0m)        │        [38;5;34m0[0m │ conv2d_14[[38;5;34m0[0m][[38;5;34m0[0m]       │
## │ ([38;5;33mGlobalAveragePoolin…[0m │                   │          │                       │
## ├───────────────────────┼───────────────────┼──────────┼───────────────────────┤
## │ dense_7 ([38;5;33mDense[0m)       │ ([38;5;45mNone[0m, [38;5;34m256[0m)       │   [38;5;34m16,640[0m │ global_average_pooli… │
## ├───────────────────────┼───────────────────┼──────────┼───────────────────────┤
...
![plot of chunk unnamed-chunk-23](/Users/tomasz/github/rstudio/keras/man/figures/functional_api/unnamed-chunk-23-1.png)
...
```
## 13/13 - 2s - 119ms/step - acc: 0.1200 - loss: 2.3110 - val_acc: 0.1150 - val_loss: 2.3192
```
...
```
## Could not deserialize class 'CustomDense' because its parent module
## <r-globalenv> cannot be imported. Full object config: {'module':
## '<r-globalenv>', 'class_name': 'CustomDense', 'config': {'units': 10},
## 'registered_name': 'CustomDense', 'build_config': {'input_shape': [None, 4]},
## 'name': 'custom_dense_1', 'inbound_nodes': [{'args': [{'class_name':
## '__keras_tensor__', 'config': {'shape': [None, 4], 'dtype': 'float32',
## 'keras_history': ['input_layer_10', 0, 0]}}], 'kwargs': {}}]}
```
...
inputs <- layer_input(batch_shape = as.integer(c(batch_size, timesteps, input_dim)))
outputs <- inputs %>%
  layer_conv_1d(filters = 32, kernel_size = 3) %>%
  custom_rnn()

model <- keras_model(inputs, outputs)
out <- model(op_zeros(c(1, 10, 32)))
```

```
## Input 0 of layer "functional_23" is incompatible with the layer: expected
## shape=(None, 10, 5), found shape=(1, 10, 32)
```
