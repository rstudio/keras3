...
Note that Keras objects are [modified in place](faq.html#why-are-keras-objects-modified-in-place-in-the-r-api) which is why it's not necessary for `model` to be assigned back to after it is compiled.
...
model %>% fit(c(data_a, data_b), labels, epochs = 10)
