...
date: 'Last Modified: 2023-12-22; Last Rendered: 2024-01-02'
vignette: >
...
## Epoch 2/2
## 750/750 - 1s - 785us/step - accuracy: 0.9508 - loss: 0.1643 - val_accuracy: 0.9581 - val_loss: 0.1423
```
...
```
## 313/313 - 0s - 360us/step - accuracy: 0.9578 - loss: 0.1338
```
...
![plot of chunk unnamed-chunk-19](../../man/figures/functional_api/unnamed-chunk-19-1.png)
...
![plot of chunk unnamed-chunk-24](../../man/figures/functional_api/unnamed-chunk-24-1.png)
...
```
## 13/13 - 1s - 112ms/step - acc: 0.1200 - loss: 2.3110 - val_acc: 0.1150 - val_loss: 2.3192
```
