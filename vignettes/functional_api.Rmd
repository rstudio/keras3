...
date: 'Last Modified: 2024-01-02; Last Rendered: 2024-01-03'
vignette: >
...
## Epoch 2/2
## 750/750 - 1s - 865us/step - accuracy: 0.9508 - loss: 0.1643 - val_accuracy: 0.9581 - val_loss: 0.1423
```
...
```
## 313/313 - 0s - 336us/step - accuracy: 0.9578 - loss: 0.1338
```
...
![plot of chunk unnamed-chunk-20](../../man/figures/functional_api/unnamed-chunk-20-1.png)
...
```
## Epoch 1/2
## 40/40 - 2s - 55ms/step - loss: 0.3948
## Epoch 2/2
## 40/40 - 1s - 17ms/step - loss: 0.1971
```
...
![plot of chunk unnamed-chunk-25](../../man/figures/functional_api/unnamed-chunk-25-1.png)
...
```
## 13/13 - 1s - 109ms/step - acc: 0.1200 - loss: 2.3110 - val_acc: 0.1150 - val_loss: 2.3192
```
