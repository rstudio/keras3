...
This guide assumes that you are already familiar with the [Sequential](https://tensorflow.rstudio.com/articles/sequential_model.html) model.

Let's start with something simple.

## First example: a densely-connected network

The [Sequential](https://tensorflow.rstudio.com/articles/sequential_model.html) model is probably a better choice to implement such a network, but it helps to start with something really simple.
