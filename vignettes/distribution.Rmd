...
mesh_1d = keras$distribution$DeviceMesh(shape = shape(8),
                                        axis_names = list("data"),
                                        devices = devices)
data_parallel <-
  keras$distribution$DataParallel(device_mesh = mesh_1d)
...
```
## Epoch 1/3
## 8/8 - 0s - 49ms/step - loss: 1.0604
## Epoch 2/3
## 8/8 - 0s - 5ms/step - loss: 0.9732
## Epoch 3/3
## 8/8 - 0s - 6ms/step - loss: 0.9253
```
...
model_parallel <- keras$distribution$ModelParallel(mesh_2d, layout_map, batch_dim_name =
                                                     "data")
...
```
## Epoch 1/3
## 8/8 - 0s - 29ms/step - loss: 1.0650
## Epoch 2/3
## 8/8 - 0s - 3ms/step - loss: 0.9721
## Epoch 3/3
## 8/8 - 0s - 3ms/step - loss: 0.9290
```
