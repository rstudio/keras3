...
## Start of epoch  2
## Training loss (for one batch) at step 200: 0.6305
## Seen so far: 12800 samples
## Training loss (for one batch) at step 400: 0.2632
## Seen so far: 25600 samples
## Training loss (for one batch) at step 600: 0.4417
## Seen so far: 38400 samples
## Start of epoch  3
...
```
## Time difference of 45.69004 secs
```
...
```
## Time difference of 0.3871596 secs
```
