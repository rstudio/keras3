...
## Start of epoch  2
## Training loss (for one batch) at step 200: 0.8495
## Seen so far: 12800 samples
## Training loss (for one batch) at step 400: 0.3543
## Seen so far: 25600 samples
## Training loss (for one batch) at step 600: 0.5087
## Seen so far: 38400 samples
## Start of epoch  3
## Training loss (for one batch) at step 200: 0.3673
## Seen so far: 12800 samples
## Training loss (for one batch) at step 400: 0.5512
## Seen so far: 25600 samples
## Training loss (for one batch) at step 600: 0.2054
## Seen so far: 38400 samples
```
...
```
## Time difference of 43.02717 secs
```
...
```
## Time difference of 0.4525867 secs
```
