...
img_path <- Sys.getenv("IMG_PATH", unset = "/images")
```
...
<div style="width=757 height=489" class="r-plot">
```{r}
knitr::include_graphics(paste0(img_path, "/training_history_ggplot2.png"))
```
</div>
