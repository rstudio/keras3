...
library(tensorflow)
library(tfdatasets)
library(keras3, mask.ok = c("shape", "set_random_seed"))
```
...
```r
x <- layer_input(shape = c(1L), dtype = "string", name = 'text') %>%
  vectorize_layer() %>%
...
```
## Epoch 1/3
## 625/625 - 6s - 10ms/step - accuracy: 0.7346 - loss: 0.4837 - val_accuracy: 0.8722 - val_loss: 0.3107
## Epoch 2/3
## 625/625 - 2s - 3ms/step - accuracy: 0.9133 - loss: 0.2168 - val_accuracy: 0.8730 - val_loss: 0.3129
## Epoch 3/3
## 625/625 - 2s - 3ms/step - accuracy: 0.9585 - loss: 0.1120 - val_accuracy: 0.8573 - val_loss: 0.4290
```
...
```
## 782/782 - 1s - 2ms/step - accuracy: 0.8495 - loss: 0.4625
```
...
```
## 782/782 - 4s - 5ms/step - accuracy: 0.8495 - loss: 0.4623
```
