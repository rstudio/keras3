...
```r
x <- keras_input(shape = c(1L), dtype = "string", name = 'text') |>
  vectorize_layer() |>
...
```
## Epoch 1/3
## 625/625 - 6s - 10ms/step - accuracy: 0.7334 - loss: 0.4873 - val_accuracy: 0.8648 - val_loss: 0.3114
## Epoch 2/3
## 625/625 - 2s - 3ms/step - accuracy: 0.9126 - loss: 0.2221 - val_accuracy: 0.8722 - val_loss: 0.3154
## Epoch 3/3
## 625/625 - 2s - 3ms/step - accuracy: 0.9583 - loss: 0.1133 - val_accuracy: 0.8638 - val_loss: 0.3984
```
...
```
## 782/782 - 1s - 2ms/step - accuracy: 0.8546 - loss: 0.4242
```
...
```
## 782/782 - 4s - 5ms/step - accuracy: 0.8546 - loss: 0.4235
```
