...
description: MIL approach to classify bags of instances and get their individual instance
  score.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Classification using Attention-based Deep Multiple Instance Learning (MIL).}
