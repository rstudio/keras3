...
description: Contrastive pretraining with SimCLR for semi-supervised image classification
  on the STL-10 dataset.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Semi-supervised image classification using contrastive pretraining with SimCLR}
