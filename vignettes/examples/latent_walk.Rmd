...
vignette: >
  %\VignetteIndexEntry{A walk through latent space with Stable Diffusion}
...
![Panda to Plane](https://raw.githubusercontent.com/keras-team/keras-io/master/examples/generative/img/random_walks_with_stable_diffusion/panda2plane.gif)
