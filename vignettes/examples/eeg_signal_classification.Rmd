...
description: Training a Convolutional model to classify EEG signals produced by exposure
  to certain stimuli.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Electroencephalogram Signal Classification for action identification}
