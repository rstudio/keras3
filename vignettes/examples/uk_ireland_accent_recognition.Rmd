...
description: Training a model to classify UK & Ireland accents using feature extraction
  from Yamnet.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{English speaker accent recognition using Transfer Learning}
