...
description: This example shows how to implement custom convolution layers using the
  `Conv.convolution_op()` API.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Customizing the convolution operation of a Conv2D layer}
