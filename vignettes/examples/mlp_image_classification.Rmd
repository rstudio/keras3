...
converted-to-keras-3-by: '[Guillaume Baquiast](https://www.linkedin.com/in/guillaume-baquiast-478965ba/),
  [divyasreepat](https://github.com/divyashreepathihalli)'
date-created: 2021/05/30
last-modified: 2023/08/03
description: Implementing the MLP-Mixer, FNet, and gMLP models for CIFAR-100 image
  classification.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Image classification with modern MLP models}
