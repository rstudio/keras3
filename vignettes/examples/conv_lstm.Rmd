...
description: How to build and train a convolutional LSTM model for next-frame video
  prediction.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Next-Frame Video Prediction with Convolutional LSTMs}
