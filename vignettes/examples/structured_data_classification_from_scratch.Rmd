...
description: Binary classification of structured data including numerical and categorical
  features.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Structured data classification from scratch}
