...
# Lets print the first 2 rows and see that max length of first 2 sequences equal to 15
x_train[1:2,]
...
# for text classification requires a preprocess fuction. Because it will be help to convert a plain text to integers 
