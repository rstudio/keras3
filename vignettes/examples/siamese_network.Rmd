...
description: Training a Siamese Network to compare the similarity of images using
  a triplet loss function.
accelerator: GPU
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Image similarity estimation using a Siamese Network with a triplet loss}
