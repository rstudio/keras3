...
Here we create a sequential model and then add layers using the pipe (`%>%`) operator:
...
The [examples](https://keras.rstudio.com/articles/examples/) demonstrate more advanced models including transfer learning, variational auto-encoding, question-answering with memory networks, text generation with stacked LSTMs, etc.

The [function reference](https://keras.rstudio.com/reference/) includes detailed information on all of the functions available in the package.
