...
1. `layer_simple_rnn()`, a fully-connected RNN where the output from previous
...
The cell abstraction, together with the generic `layer_rnn()` class, make it
...
Please also note that a sequential model can not be used in this case since it only
