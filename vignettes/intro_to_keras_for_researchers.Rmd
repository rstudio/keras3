...
## array([[ 0.90574193,  0.7916686 ],
##        [ 0.28754202, -0.5408821 ]], dtype=float32)>
```
...
```
## tf.Tensor(
## [[ 0.9969011  -0.77071446]
##  [ 0.23378514  0.9625516 ]], shape=(2, 2), dtype=float32)
```
...
```
## tf.Tensor(
## [[3.3447742e-03 7.1282017e-01]
##  [5.7464113e+00 5.5013239e-02]], shape=(2, 2), dtype=float32)
```
...
```
## tf.Tensor(1.281973, shape=(), dtype=float32)
```
...
```
## tf.Tensor(
## [[ 0.0388482  -0.03920118  0.01624807 -0.01361975 -0.013549    0.07107338
##   -0.01077365  0.05688906 -0.02838149 -0.0408462 ]
##  [ 0.0388482  -0.03920118  0.01624807 -0.01361975 -0.013549    0.07107338
##   -0.01077365  0.05688906 -0.02838149 -0.0408462 ]
##  [ 0.0388482  -0.03920118  0.01624807 -0.01361975 -0.013549    0.07107338
##   -0.01077365  0.05688906 -0.02838149 -0.0408462 ]
...
##   -0.01077365  0.05688906 -0.02838149 -0.0408462 ]
##  [ 0.0388482  -0.03920118  0.01624807 -0.01361975 -0.013549    0.07107338
##   -0.01077365  0.05688906 -0.02838149 -0.0408462 ]], shape=(10, 10), dtype=float32)
```
...
```
## Epoch 1/2
## 938/938 - 1s - 846us/step - loss: 0.3958 - sparse_categorical_accuracy: 0.8866
## Epoch 2/2
## 938/938 - 1s - 602us/step - loss: 0.1888 - sparse_categorical_accuracy: 0.9443
```
...
```
## 938/938 - 0s - 367us/step - loss: 0.1763 - sparse_categorical_accuracy: 0.9454
```
...
```
## Epoch 1/2
## 938/938 - 1s - 780us/step - loss: 0.3869 - sparse_categorical_accuracy: 0.8924
## Epoch 2/2
## 938/938 - 1s - 603us/step - loss: 0.2163 - sparse_categorical_accuracy: 0.9370
```
...
## Step: 700 Loss: 0.07790598
## Step: 800 Loss: 0.07670418
## Step: 900 Loss: 0.07570736
## Step: 1000 Loss: 0.07476592
```
...
## Step: 200 Loss: 2.236468
## Step: 300 Loss: 2.119413
## Step: 400 Loss: 2.040315
## Step: 500 Loss: 1.949096
## Step: 600 Loss: 1.859365
## Step: 700 Loss: 1.845711
## Step: 800 Loss: 1.820584
## Step: 900 Loss: 1.771324
## Step: 1000 Loss: 1.730642
```
