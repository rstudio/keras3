...
```
Now `layer_linear` is a layer constructor composes nicely with `%>%`, just like the built in layers:
```{r}
...
your layer instance is called. You now have a layer that's lazy and thus easier to use:
