...
For the remainder of this vignette we'll be using the `%py_class%` constructor, 
only because it does less and for that reason is maybe more illuminating for the purpose of a guide like this. However,
