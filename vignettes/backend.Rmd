...
If you want to use the CNTK backend then you should follow the [installation instructions](https://docs.microsoft.com/en-us/cognitive-toolkit/setup-cntk-on-your-machine) for CNTK and then set the `KERAS_BACKEND` environment variable before loading the keras R package as follows:
...
[\`function\`](https://keras.io/backend/#function)                                             Instantiates a Keras function.
...
[reset_uids](https://keras.io/backend/#reset_uids)                                             Reset graph identifiers.                    
...
[update](https://keras.io/backend/#update)                                                     Update the value of `x` to `new_x`.                  
