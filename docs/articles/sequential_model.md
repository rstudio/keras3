...
[`pop_layer()`](https://keras3.posit.co/reference/pop_layer.md) method
to remove layers: a Sequential model behaves very much like a stack of
layers.
...
- Train your model, evaluate it, and run inference. See our [guide to
  ...
  loops](https://keras3.posit.co/articles/training_with_built_in_methods.md)
...
API model](https://keras3.posit.co/articles/functional_api.md). This
...
learning](https://keras3.posit.co/articles/transfer_learning.md).
