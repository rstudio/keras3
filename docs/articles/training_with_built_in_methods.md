...
```
    ...
    ## Epoch 1/3
    ## 782/782 - 2s - 3ms/step - loss: 0.3365 - sparse_categorical_accuracy: 0.9041
    ## Epoch 2/3
...
```
    ...
    ## 4/4 - 2s - 557ms/step - class_output_categorical_accuracy: 0.2300 - class_output_loss: 1.8162 - loss: 3.8764 - score_output_loss: 1.6820 - score_output_mean_absolute_error: 0.8826 - score_output_mean_absolute_percentage_error: 1826.5676
...
```
    ...
    ## 4/4 - 2s - 422ms/step - class_output_loss: 4.1489 - loss: 4.5443 - score_output_loss: -4.1125e-01
...
```
    ...
    ## 2/2 - 1s - 718ms/step - class_output_loss: 3.8547 - loss: 3.5725 - score_output_loss: -1.5209e-01
...
callbacks](https://keras3.posit.co/writing_your_own_callbacks.md).
