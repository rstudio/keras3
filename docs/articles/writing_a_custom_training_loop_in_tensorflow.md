...
```
    ...
    ## Start of epoch  2
    ## Training loss (for one batch) at step 200: 0.5089
    ## Seen so far: 12800 samples
    ## Training loss (for one batch) at step 400: 0.2498
    ## Seen so far: 25600 samples
    ## Training loss (for one batch) at step 600: 0.4186
    ## Seen so far: 38400 samples
    ## Start of epoch  3
    ## Training loss (for one batch) at step 200: 0.3609
    ## Seen so far: 12800 samples
    ## Training loss (for one batch) at step 400: 0.4127
    ## Seen so far: 25600 samples
    ## Training loss (for one batch) at step 600: 0.1738
    ## Seen so far: 38400 samples
...
```
    ...
    ## Time difference of 42.24861 secs
...
```
    ...
    ## Time difference of 0.4167948 secs
