...
scratch](https://keras3.posit.co/articles/making_new_layers_and_models_via_subclassing.md).
...
```
    ...
    ## 146/146 - 57s - 392ms/step - binary_accuracy: 0.9183 - loss: 0.1887 - val_binary_accuracy: 0.9669 - val_loss: 0.0926
...
```
    ...
    ## 146/146 - 88s - 603ms/step - binary_accuracy: 0.8660 - loss: 0.3213 - val_binary_accuracy: 0.9652 - val_loss: 0.1022
