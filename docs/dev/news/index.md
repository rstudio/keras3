...
- Added complex-valued helpers: S3
  ...
  [`op_angle()`](https://keras3.posit.co/dev/reference/op_angle.md), and
  conversions
...
- Fixed an issue where
  ...
  would sometimes return a TensorFlow `TensorShape`

- Fixes for
  [`metric_iou()`](https://keras3.posit.co/dev/reference/metric_iou.md),
  [`op_top_k()`](https://keras3.posit.co/dev/reference/op_top_k.md), and
  [`op_eye()`](https://keras3.posit.co/dev/reference/op_eye.md) being
...
- `%*%` now dispatches to
  ...
  for tensorflow tensors, which has relaxed shape constraints compared
  to `tf$matmul()`.
...
- When using
  [`get_file()`](https://keras3.posit.co/dev/reference/get_file.md) with
...
- `keras_shape` objects (as returned by
  [`keras3::shape()`](https://keras3.posit.co/dev/reference/shape.md))
  gain `==` and `!=` methods.
...
- Added compatibility with Keras v3.4.0. User facing changes:
  ...
  - Changes:
    ...
    - [`Layer()`](https://keras3.posit.co/dev/reference/Layer.md)
      instances gain attributes `path` and `quantization_mode`.
...
- new [`Layer()`](https://keras3.posit.co/dev/reference/Layer.md)
...
- [`to_categorical()`](https://keras3.posit.co/dev/reference/to_categorical.md),
  [`op_one_hot()`](https://keras3.posit.co/dev/reference/op_one_hot.md),
  and [`fit()`](https://generics.r-lib.org/reference/fit.html) can now
...
- [`op_array()`](https://keras3.posit.co/dev/reference/op_array.md) and
  [`op_convert_to_tensor()`](https://keras3.posit.co/dev/reference/op_convert_to_tensor.md)
...
- [`layer_lstm()`](https://keras3.posit.co/dev/reference/layer_lstm.md)
  ...
  gain arg `use_cudnn`, default `'auto'`.
