...
A tensor of shape `(..., N, M)` containing the pseudoinverse of each
...
## Examples
    ...
    ## tf.Tensor(
    ## [[ 1.0000004e+00 -4.7683716e-07]
    ##  [-1.7881393e-07  1.0000001e+00]], shape=(2, 2), dtype=float32)
