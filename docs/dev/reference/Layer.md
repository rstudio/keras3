...
The first argument of the returned function will be `object`, enabling
...
- [`get_config()`](https://keras3.posit.co/dev/reference/get_config.md):
  ...
  as well. This method is used when saving the layer or a model that
  contains this layer.
...
- add_weight(shape = NULL,
  ...
  - `shape`: shape for the variable (as defined by
    [`shape()`](https://keras3.posit.co/dev/reference/shape.md)) Must be
