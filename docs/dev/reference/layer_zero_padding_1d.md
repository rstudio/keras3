...
``` r
layer_zero_padding_1d(object, padding = 1L, data_format = NULL, ...)
```
...
- padding:
  ...
  - If int: how many zeros to add at the beginning and end of the
    padding dimension (axis 2).
...
- data_format:
  ...
  `(batch_size, channels, axis_to_pad)`. When unspecified, uses
