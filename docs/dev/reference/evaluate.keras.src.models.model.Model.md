...
A named list of scalar metrics, including the loss value. Metric results
are returned with stable names, including compiled metrics that may
expand into multiple reported values.
