...
The result has the same sign as the dividend `x1`, unlike
[`op_mod()`](https://keras3.posit.co/dev/reference/op_mod.md), whose
...
A tensor containing the element-wise remainder.
