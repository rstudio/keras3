...
entire 1D feature maps instead of individual elements. If adjacent
frames within feature maps are strongly correlated (as is normally the
...
effective learning rate decrease. In this case, `SpatialDropout1D` will
