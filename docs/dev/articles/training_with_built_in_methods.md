...
happens in `fit()`
guide](https://keras3.posit.co/dev/articles/custom_train_step_in_tensorflow.md).
...
scratch](https://keras3.posit.co/dev/articles/writing_a_custom_training_loop_in_tensorflow.md).
...
\[[`Loss()`](https://keras3.posit.co/dev/reference/Loss.md)\] and
...
\[[`Metric()`](https://keras3.posit.co/dev/reference/Metric.md)\]. You
will need to implement 4 methods:
...
class. A callback has access to its associated model through the class
property `self$model`.
...
Models](https://keras3.posit.co/dev/articles/serialization_and_saving.md).
