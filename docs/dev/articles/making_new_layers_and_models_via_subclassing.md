...
```
    ...
    ## 1/1 - 0s - 106ms/step - loss: 1.6613

## You can optionally enable serialization on your layers

If you need your custom layers to be serializable as part of a
[Functional
model](https://keras3.posit.co/dev/articles/functional_api.md), you can
...
class method. This is the base implementation of
[`from_config()`](https://keras3.posit.co/dev/reference/get_config.md):
