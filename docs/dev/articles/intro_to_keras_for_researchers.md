...
[here](https://keras3.posit.co/dev/articles/functional_api.md).
...
- [Callbacks](https://keras3.posit.co/reference/index.html#callbacks).
  ...
  [implement custom
  callbacks](https://keras3.posit.co/dev/articles/writing_your_own_callbacks.md)
  if needed.
- [Distributed
  training](https://keras3.posit.co/dev/articles/distributed_training_with_tensorflow.md).
