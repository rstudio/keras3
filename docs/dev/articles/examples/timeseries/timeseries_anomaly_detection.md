...
We will use the [Numenta Anomaly
Benchmark(NAB)](https://www.kaggle.com/boltzmannbrain/nab) dataset. It
provides artificial timeseries data containing labeled anomalous periods
of behavior. Data are ordered, timestamped, single-valued metrics.
...
![plot of chunk
unnamed-chunk-4](timeseries_anomaly_detection/unnamed-chunk-4-1.png)

plot of chunk unnamed-chunk-4

### Timeseries data with anomalies

We will use the following data for testing and see if the sudden jump up
in the data is detected as an anomaly.
...
![plot of chunk
unnamed-chunk-5](timeseries_anomaly_detection/unnamed-chunk-5-1.png)
...
`(batch_size, sequence_length, num_features)` and return output of the
same shape. In this case, `sequence_length` is 288 and `num_features` is
1.
...
```
    ...
    ## Epoch 1/50
    ## 106/106 - 6s - 59ms/step - loss: 0.1863 - val_loss: 0.0316
    ## Epoch 2/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0333 - val_loss: 0.0233
    ## Epoch 3/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0248 - val_loss: 0.0201
    ## Epoch 4/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0209 - val_loss: 0.0186
    ## Epoch 5/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0179 - val_loss: 0.0146
    ## Epoch 6/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0150 - val_loss: 0.0112
    ## Epoch 7/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0127 - val_loss: 0.0094
    ## Epoch 8/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0109 - val_loss: 0.0088
    ## Epoch 9/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0096 - val_loss: 0.0083
    ## Epoch 10/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0086 - val_loss: 0.0069
    ## Epoch 11/50
    ...
    ## Epoch 16/50
    ## 106/106 - 0s - 2ms/step - loss: 0.0058 - val_loss: 0.0040
    ## Epoch 17/50
    ## 106/106 - 0s - 2ms/step - loss: 0.0056 - val_loss: 0.0041
    ## Epoch 18/50
    ...
    ## Epoch 24/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0041 - val_loss: 0.0030
    ## Epoch 25/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0039 - val_loss: 0.0032
    ## Epoch 26/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0037 - val_loss: 0.0030
    ## Epoch 27/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0035 - val_loss: 0.0031
    ## Epoch 28/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0034 - val_loss: 0.0025
    ## Epoch 29/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0033 - val_loss: 0.0028
    ## Epoch 30/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0032 - val_loss: 0.0030
    ## Epoch 31/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0031 - val_loss: 0.0024
    ## Epoch 32/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0030 - val_loss: 0.0028
    ## Epoch 33/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0029 - val_loss: 0.0027
    ## Epoch 34/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0028 - val_loss: 0.0023
    ## Epoch 35/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0027 - val_loss: 0.0024
    ## Epoch 36/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0026 - val_loss: 0.0025
    ## Epoch 37/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0026 - val_loss: 0.0026
    ## Epoch 38/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0025 - val_loss: 0.0025
    ## Epoch 39/50
    ## 106/106 - 0s - 3ms/step - loss: 0.0025 - val_loss: 0.0024
...
![plot of chunk
unnamed-chunk-10](timeseries_anomaly_detection/unnamed-chunk-10-1.png)

plot of chunk unnamed-chunk-10

## Detecting anomalies

We will detect anomalies by determining how well our model can
reconstruct the input data.

1.  Find MAE loss on training samples.
2.  Find max MAE loss value. This is the worst our model has performed
    trying to reconstruct a sample. We will make this the `threshold`
    for anomaly detection.
3.  If the reconstruction loss for a sample is greater than this
    `threshold` value then we can infer that the model is seeing a
    pattern that it isn’t familiar with. We will label this sample as an
    `anomaly`.
...
![plot of chunk
unnamed-chunk-11](timeseries_anomaly_detection/unnamed-chunk-11-1.png)
...
```
    ...
    ## Reconstruction error threshold:  0.03916351

### Compare reconstruction

Just for fun, let’s see how our model has reconstructed the first
sample. This is the 288 timesteps from day 1 of our training dataset.
...
![plot of chunk
unnamed-chunk-12](timeseries_anomaly_detection/unnamed-chunk-12-1.png)
...
![plot of chunk
unnamed-chunk-13](timeseries_anomaly_detection/unnamed-chunk-13-1.png)
...
![plot of chunk
unnamed-chunk-13](timeseries_anomaly_detection/unnamed-chunk-13-2.png)
...
```
    ...
    ## Indices of anomaly samples: 216 217 218 219 220 221 396 507 793 794 795 797
    ## 798 799 853 861 974 1658 1659 1944 1945 1946 1947 1949 2008 2012 2016 2020
    ## 2024 2028 2036 2040 2044 2045 2046 2048 2052 2053 2054 2056 2057 2058 2060
    ## 2061 2062 2064 2065 2066 2068 2069 2070 2072 2073 2074 2076 2077 2078 2080
    ## 2081 2082 2083 2084 2085 2086 2088 2089 2090 2092 2093 2094 2096 2097 2098
    ## 2100 2101 2102 2104 2105 2108 2109 2110 2112 2113 2116 2117 2120 2121 2124
    ## 2126 2141 2520 2521 2522 2523 2525 2698 2700 2702 2703 2704 2705 2706 2707
...
We now know the samples of the data which are anomalies. With this, we
will find the corresponding `timestamps` from the original test data. We
will be using the following method to do that:
...
appear in `time_steps` number of samples. So, if we know that the
samples \[(3, 4, 5), (4, 5, 6), (5, 6, 7)\] are anomalies, we can say
...
![plot of chunk
unnamed-chunk-14](timeseries_anomaly_detection/unnamed-chunk-14-1.png)
