...
- If you pass arrays, by calling `fit(x, y, ...)`, then `data` will be
  the list `(x, y)`
- If you pass a `tf_dataset`, by calling `fit(dataset, ...)`, then
...
```
    ...
    ## Epoch 1/3
    ## 32/32 - 1s - 26ms/step - mae: 1.4339 - loss: 3.2271
    ## Epoch 2/3
...
```
    ...
    ## Epoch 1/3
    ## 32/32 - 1s - 24ms/step - mae: 1.3434 - loss: 0.1681
    ## Epoch 2/3
...
```
    ...
    ## 100/100 - 7s - 65ms/step - d_loss: 0.0000e+00 - g_loss: 0.0000e+00
