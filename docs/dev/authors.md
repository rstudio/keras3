...
Source:
[`DESCRIPTION`](https://github.com/rstudio/keras3/blob/HEAD/DESCRIPTION)

Kalinowski T, Allaire J, Chollet F (2025). *keras3: R Interface to
'Keras'*. R package version 1.4.0.9000, <https://keras3.posit.co/>.
