...
to compute the sensitivity at the given specificity. The threshold for
the given specificity value is computed and used to evaluate the
...
- num_thresholds:
  ...
  matching the given specificity.
