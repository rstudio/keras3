...
entire 2D feature maps instead of individual elements. If adjacent
...
effective learning rate decrease. In this case, `SpatialDropout2D` will
...
- data_format:
  ...
  mode is it at index 3. It defaults to the `image_data_format` value
