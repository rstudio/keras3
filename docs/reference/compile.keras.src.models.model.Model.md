...
- loss:
  ...
  - a [`Loss`](https://keras3.posit.co/reference/Loss.md) instance
...
- metrics:
  ...
  - a [`Metric()`](https://keras3.posit.co/reference/Metric.md)
  ...
  [`custom_metric("my_custom_metric_name", <fn>)`](https://keras3.posit.co/reference/custom_metric.md)
