...
- dims:
  ...
  List of integers. Permutation pattern does not include the batch
  dimension. Indexing starts at 1. For instance, `(1, 3, 2)` permutes
  the second and third dimensions of the input.
...
Same as the input shape, but with the dimensions re-ordered according to
