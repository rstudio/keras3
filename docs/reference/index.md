...
- [`Model()`](https://keras3.posit.co/reference/Model.md) :
...
- [`plot(`*`<keras_training_history>`*`)`](https://keras3.posit.co/reference/plot.keras_training_history.md)
...
- [`freeze_weights()`](https://keras3.posit.co/reference/freeze_weights.md)
  [`unfreeze_weights()`](https://keras3.posit.co/reference/freeze_weights.md)
...
- [`summary(`*`<keras.src.models.model.Model>`*`)`](https://keras3.posit.co/reference/summary.keras.src.models.model.Model.md)
  [`format(`*`<keras.src.models.model.Model>`*`)`](https://keras3.posit.co/reference/summary.keras.src.models.model.Model.md)
  [`print(`*`<keras.src.models.model.Model>`*`)`](https://keras3.posit.co/reference/summary.keras.src.models.model.Model.md)
  : Print a summary of a Keras Model
- [`plot(`*`<keras.src.models.model.Model>`*`)`](https://keras3.posit.co/reference/plot.keras.src.models.model.Model.md)
  : Plot a Keras model
- [`get_config()`](https://keras3.posit.co/reference/get_config.md)
  [`from_config()`](https://keras3.posit.co/reference/get_config.md) :
  Layer/Model configuration
- [`get_weights()`](https://keras3.posit.co/reference/get_weights.md)
  [`set_weights()`](https://keras3.posit.co/reference/get_weights.md) :
...
- [`save_model_config()`](https://keras3.posit.co/reference/save_model_config.md)
  [`load_model_config()`](https://keras3.posit.co/reference/save_model_config.md)
...
- [`layer_rnn()`](https://keras3.posit.co/reference/layer_rnn.md) : Base
...
- [`reset_state()`](https://keras3.posit.co/reference/reset_state.md) :
...
- [`layer_feature_space()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_cross()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_custom()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_float()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_float_rescaled()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_float_normalized()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_float_discretized()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_integer_categorical()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_string_categorical()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_string_hashed()`](https://keras3.posit.co/reference/layer_feature_space.md)
  [`feature_integer_hashed()`](https://keras3.posit.co/reference/layer_feature_space.md)
...
- [`layer_text_vectorization()`](https://keras3.posit.co/reference/layer_text_vectorization.md)
  [`get_vocabulary()`](https://keras3.posit.co/reference/layer_text_vectorization.md)
  [`set_vocabulary()`](https://keras3.posit.co/reference/layer_text_vectorization.md)
  : A preprocessing layer which maps text features to integer sequences.

- [`layer_pipeline()`](https://keras3.posit.co/reference/layer_pipeline.md)
  : Applies a series of layers to an input.

- [`adapt()`](https://keras3.posit.co/reference/adapt.md) : Fits the
...
- [`op_cast()`](https://keras3.posit.co/reference/op_cast.md) : Cast a
  tensor to the desired dtype.

- [`op_cond()`](https://keras3.posit.co/reference/op_cond.md) :
...
- [`op_dtype()`](https://keras3.posit.co/reference/op_dtype.md) : Return
  the dtype of the tensor input as a standardized string.

- [`op_fori_loop()`](https://keras3.posit.co/reference/op_fori_loop.md)
  : For loop implementation.

- [`op_is_tensor()`](https://keras3.posit.co/reference/op_is_tensor.md)
  : Check whether the given object is a tensor.

- [`op_map()`](https://keras3.posit.co/reference/op_map.md) : Map a
...
- [`op_scan()`](https://keras3.posit.co/reference/op_scan.md) : Scan a
  function over leading array axes while carrying along state.

- [`op_scatter()`](https://keras3.posit.co/reference/op_scatter.md) :

  Returns a tensor of shape `shape` where `indices` are set to `values`.

- [`op_scatter_update()`](https://keras3.posit.co/reference/op_scatter_update.md)
...
- [`op_shape()`](https://keras3.posit.co/reference/op_shape.md) : Gets
  the shape of the tensor input.

- [`op_slice()`](https://keras3.posit.co/reference/op_slice.md) : Return
  a slice of an input tensor.

- [`op_slice_update()`](https://keras3.posit.co/reference/op_slice_update.md)
  : Update an input by slicing in a tensor of updated values.

- [`op_stop_gradient()`](https://keras3.posit.co/reference/op_stop_gradient.md)
  : Stops gradient computation.

- [`op_subset()`](https://keras3.posit.co/reference/op_subset.md)
  [`` `op_subset<-`() ``](https://keras3.posit.co/reference/op_subset.md)
  [`op_subset_set()`](https://keras3.posit.co/reference/op_subset.md) :
...
- [`op_unstack()`](https://keras3.posit.co/reference/op_unstack.md) :
  Unpacks the given dimension of a rank-R tensor into rank-(R-1)
  tensors.

- [`op_vectorized_map()`](https://keras3.posit.co/reference/op_vectorized_map.md)
  :

  Parallel map of function `f` on the first axis of tensor(s)
  `elements`.

- [`op_while_loop()`](https://keras3.posit.co/reference/op_while_loop.md)
  : While loop implementation.

### Math Operations

- [`op_erf()`](https://keras3.posit.co/reference/op_erf.md) :
...
- [`op_extract_sequences()`](https://keras3.posit.co/reference/op_extract_sequences.md)
  :

  Expands the dimension of last axis into sequences of
  `sequence_length`.

- [`op_fft()`](https://keras3.posit.co/reference/op_fft.md) : Computes
  the Fast Fourier Transform along last axis of input.

- [`op_fft2()`](https://keras3.posit.co/reference/op_fft2.md) : Computes
  the 2D Fast Fourier Transform along the last two axes of input.
...
- [`op_in_top_k()`](https://keras3.posit.co/reference/op_in_top_k.md) :
  Checks if the targets are in the top-k predictions.

- [`op_irfft()`](https://keras3.posit.co/reference/op_irfft.md) :
  Inverse real-valued Fast Fourier transform along the last axis.

- [`op_istft()`](https://keras3.posit.co/reference/op_istft.md) :
  Inverse Short-Time Fourier Transform along the last axis of the input.

- [`op_logsumexp()`](https://keras3.posit.co/reference/op_logsumexp.md)
  : Computes the logarithm of sum of exponentials of elements in a
  tensor.

- [`op_qr()`](https://keras3.posit.co/reference/op_qr.md) : Computes the
  QR decomposition of a tensor.

- [`op_rfft()`](https://keras3.posit.co/reference/op_rfft.md) :
  Real-valued Fast Fourier Transform along the last axis of the input.

- [`op_rsqrt()`](https://keras3.posit.co/reference/op_rsqrt.md) :
  Computes reciprocal of square root of x element-wise.

- [`op_segment_max()`](https://keras3.posit.co/reference/op_segment_max.md)
  : Computes the max of segments in a tensor.

- [`op_segment_sum()`](https://keras3.posit.co/reference/op_segment_sum.md)
  : Computes the sum of segments in a tensor.

- [`op_solve()`](https://keras3.posit.co/reference/op_solve.md) :

  Solves a linear system of equations given by `a x = b`.

- [`op_stft()`](https://keras3.posit.co/reference/op_stft.md) :
  Short-Time Fourier Transform along the last axis of the input.

- [`op_top_k()`](https://keras3.posit.co/reference/op_top_k.md) : Finds
  the top-k values and their indices in a tensor.

### General Tensor Operations

- [`op_abs()`](https://keras3.posit.co/reference/op_abs.md) : Compute
  the absolute value element-wise.

- [`op_add()`](https://keras3.posit.co/reference/op_add.md) : Add
  arguments element-wise.

- [`op_all()`](https://keras3.posit.co/reference/op_all.md) :

  Test whether all array elements along a given axis evaluate to `TRUE`.

- [`op_angle()`](https://keras3.posit.co/reference/op_angle.md) :
  Element-wise angle of a complex tensor.

- [`op_any()`](https://keras3.posit.co/reference/op_any.md) :

  Test whether any array element along a given axis evaluates to `TRUE`.

- [`op_append()`](https://keras3.posit.co/reference/op_append.md) :
...
- [`op_arccos()`](https://keras3.posit.co/reference/op_arccos.md) :
  Trigonometric inverse cosine, element-wise.

- [`op_arccosh()`](https://keras3.posit.co/reference/op_arccosh.md) :
  Inverse hyperbolic cosine, element-wise.

- [`op_arcsin()`](https://keras3.posit.co/reference/op_arcsin.md) :
  Inverse sine, element-wise.

- [`op_arcsinh()`](https://keras3.posit.co/reference/op_arcsinh.md) :
  Inverse hyperbolic sine, element-wise.

- [`op_arctan()`](https://keras3.posit.co/reference/op_arctan.md) :
  Trigonometric inverse tangent, element-wise.

- [`op_arctan2()`](https://keras3.posit.co/reference/op_arctan2.md) :

  Element-wise arc tangent of `x1/x2` choosing the quadrant correctly.

- [`op_arctanh()`](https://keras3.posit.co/reference/op_arctanh.md) :
...
- [`op_array()`](https://keras3.posit.co/reference/op_array.md) : Create
  a tensor.

- [`op_average()`](https://keras3.posit.co/reference/op_average.md) :
...
- [`op_broadcast_to()`](https://keras3.posit.co/reference/op_broadcast_to.md)
  : Broadcast a tensor to a new shape.

- [`op_cbrt()`](https://keras3.posit.co/reference/op_cbrt.md) : Computes
  the cube root of the input tensor, element-wise.

- [`op_ceil()`](https://keras3.posit.co/reference/op_ceil.md) : Return
  the ceiling of the input, element-wise.

- [`op_clip()`](https://keras3.posit.co/reference/op_clip.md) : Clip
  (limit) the values in a tensor.

- [`op_concatenate()`](https://keras3.posit.co/reference/op_concatenate.md)
  : Join a sequence of tensors along an existing axis.

- [`op_conj()`](https://keras3.posit.co/reference/op_conj.md) : Returns
  the complex conjugate, element-wise.

- [`op_copy()`](https://keras3.posit.co/reference/op_copy.md) :
...
- [`op_cos()`](https://keras3.posit.co/reference/op_cos.md) : Cosine,
  element-wise.

- [`op_cosh()`](https://keras3.posit.co/reference/op_cosh.md) :
  Hyperbolic cosine, element-wise.

- [`op_count_nonzero()`](https://keras3.posit.co/reference/op_count_nonzero.md)
  :

  Counts the number of non-zero values in `x` along the given `axis`.

- [`op_cross()`](https://keras3.posit.co/reference/op_cross.md) :
  Returns the cross product of two (arrays of) vectors.

- [`op_ctc_decode()`](https://keras3.posit.co/reference/op_ctc_decode.md)
  : Decodes the output of a CTC model.

- [`op_cumprod()`](https://keras3.posit.co/reference/op_cumprod.md) :
  Return the cumulative product of elements along a given axis.

- [`op_cumsum()`](https://keras3.posit.co/reference/op_cumsum.md) :
  Returns the cumulative sum of elements along a given axis.

- [`op_deg2rad()`](https://keras3.posit.co/reference/op_deg2rad.md) :
  Convert angles from degrees to radians.

- [`op_diag()`](https://keras3.posit.co/reference/op_diag.md) : Extract
...
- [`op_diagonal()`](https://keras3.posit.co/reference/op_diagonal.md) :
  Return specified diagonals.

- [`op_diff()`](https://keras3.posit.co/reference/op_diff.md) :
...
- [`op_divide()`](https://keras3.posit.co/reference/op_divide.md) :
...
- [`op_dot()`](https://keras3.posit.co/reference/op_dot.md) : Dot
  product of two tensors.

- [`op_einsum()`](https://keras3.posit.co/reference/op_einsum.md) :
  Evaluates the Einstein summation convention on the operands.

- [`op_empty()`](https://keras3.posit.co/reference/op_empty.md) : Return
  a tensor of given shape and type filled with uninitialized data.

- [`op_equal()`](https://keras3.posit.co/reference/op_equal.md) :

  Returns `(x1 == x2)` element-wise.

- [`op_exp()`](https://keras3.posit.co/reference/op_exp.md) : Calculate
  the exponential of all elements in the input tensor.

- [`op_exp2()`](https://keras3.posit.co/reference/op_exp2.md) :
  Calculate the base-2 exponential of all elements in the input tensor.

- [`op_expand_dims()`](https://keras3.posit.co/reference/op_expand_dims.md)
  : Expand the shape of a tensor.

- [`op_expm1()`](https://keras3.posit.co/reference/op_expm1.md) :

  Calculate `exp(x) - 1` for all elements in the tensor.

- [`op_eye()`](https://keras3.posit.co/reference/op_eye.md) : Return a
  2-D tensor with ones on the diagonal and zeros elsewhere.

- [`op_flip()`](https://keras3.posit.co/reference/op_flip.md) : Reverse
  the order of elements in the tensor along the given axis.

- [`op_floor()`](https://keras3.posit.co/reference/op_floor.md) : Return
  the floor of the input, element-wise.

- [`op_floor_divide()`](https://keras3.posit.co/reference/op_floor_divide.md)
  : Returns the largest integer smaller or equal to the division of
  inputs.

- [`op_full()`](https://keras3.posit.co/reference/op_full.md) :

  Return a new tensor of given shape and type, filled with `fill_value`.

- [`op_full_like()`](https://keras3.posit.co/reference/op_full_like.md)
  : Return a full tensor with the same shape and type as the given
  tensor.

- [`op_get_item()`](https://keras3.posit.co/reference/op_get_item.md) :

  Return `x[key]`.

- [`op_greater()`](https://keras3.posit.co/reference/op_greater.md) :

  Return the truth value of `x1 > x2` element-wise.

- [`op_greater_equal()`](https://keras3.posit.co/reference/op_greater_equal.md)
  :
...
- [`op_hanning()`](https://keras3.posit.co/reference/op_hanning.md) :
...
- [`op_hstack()`](https://keras3.posit.co/reference/op_hstack.md) :
  Stack tensors in sequence horizontally (column wise).

- [`op_identity()`](https://keras3.posit.co/reference/op_identity.md) :
  Return the identity tensor.

- [`op_imag()`](https://keras3.posit.co/reference/op_imag.md) : Return
  the imaginary part of the complex argument.

- [`op_inner()`](https://keras3.posit.co/reference/op_inner.md) : Return
...
- [`op_isfinite()`](https://keras3.posit.co/reference/op_isfinite.md) :
  Return whether a tensor is finite, element-wise.

- [`op_isinf()`](https://keras3.posit.co/reference/op_isinf.md) : Test
  element-wise for positive or negative infinity.

- [`op_isnan()`](https://keras3.posit.co/reference/op_isnan.md) : Test
  element-wise for NaN and return result as a boolean tensor.

- [`op_kaiser()`](https://keras3.posit.co/reference/op_kaiser.md) :
  Kaiser window function.

- [`op_left_shift()`](https://keras3.posit.co/reference/op_left_shift.md)
  : Shift the bits of an integer to the left.

- [`op_less()`](https://keras3.posit.co/reference/op_less.md) :

  Return the truth value of `x1 < x2` element-wise.

- [`op_less_equal()`](https://keras3.posit.co/reference/op_less_equal.md)
  :

  Return the truth value of `x1 <= x2` element-wise.

- [`op_linspace()`](https://keras3.posit.co/reference/op_linspace.md) :
  Return evenly spaced numbers over a specified interval.

- [`op_log()`](https://keras3.posit.co/reference/op_log.md) : Natural
  logarithm, element-wise.

- [`op_log10()`](https://keras3.posit.co/reference/op_log10.md) : Return
  the base 10 logarithm of the input tensor, element-wise.

- [`op_log1p()`](https://keras3.posit.co/reference/op_log1p.md) :

  Returns the natural logarithm of one plus the `x`, element-wise.

- [`op_log2()`](https://keras3.posit.co/reference/op_log2.md) :

  Base-2 logarithm of `x`, element-wise.

- [`op_logaddexp()`](https://keras3.posit.co/reference/op_logaddexp.md)
...
- [`op_logical_and()`](https://keras3.posit.co/reference/op_logical_and.md)
  : Computes the element-wise logical AND of the given input tensors.

- [`op_logical_not()`](https://keras3.posit.co/reference/op_logical_not.md)
  : Computes the element-wise NOT of the given input tensor.

- [`op_logical_or()`](https://keras3.posit.co/reference/op_logical_or.md)
  : Computes the element-wise logical OR of the given input tensors.

- [`op_logical_xor()`](https://keras3.posit.co/reference/op_logical_xor.md)
  :

  Compute the truth value of `x1 XOR x2`, element-wise.

- [`op_logspace()`](https://keras3.posit.co/reference/op_logspace.md) :
  Returns numbers spaced evenly on a log scale.

- [`op_lstsq()`](https://keras3.posit.co/reference/op_lstsq.md) : Return
  the least-squares solution to a linear matrix equation.

- [`op_matmul()`](https://keras3.posit.co/reference/op_matmul.md) :
  Matrix product of two tensors.

- [`op_max()`](https://keras3.posit.co/reference/op_max.md) : Return the
  maximum of a tensor or maximum along an axis.

- [`op_maximum()`](https://keras3.posit.co/reference/op_maximum.md)
  [`op_pmax()`](https://keras3.posit.co/reference/op_maximum.md) :

  Element-wise maximum of `x1` and `x2`.

- [`op_mean()`](https://keras3.posit.co/reference/op_mean.md) : Compute
  the arithmetic mean along the specified axes.

- [`op_median()`](https://keras3.posit.co/reference/op_median.md) :
  Compute the median along the specified axis.

- [`op_meshgrid()`](https://keras3.posit.co/reference/op_meshgrid.md) :
  Creates grids of coordinates from coordinate vectors.

- [`op_min()`](https://keras3.posit.co/reference/op_min.md) : Return the
  minimum of a tensor or minimum along an axis.

- [`op_minimum()`](https://keras3.posit.co/reference/op_minimum.md)
  [`op_pmin()`](https://keras3.posit.co/reference/op_minimum.md) :

  Element-wise minimum of `x1` and `x2`.

- [`op_mod()`](https://keras3.posit.co/reference/op_mod.md) : Returns
  the element-wise remainder of division.

- [`op_moveaxis()`](https://keras3.posit.co/reference/op_moveaxis.md) :
  Move axes of a tensor to new positions.

- [`op_multiply()`](https://keras3.posit.co/reference/op_multiply.md) :
  Multiply arguments element-wise.

- [`op_nan_to_num()`](https://keras3.posit.co/reference/op_nan_to_num.md)
  : Replace NaN with zero and infinity with large finite numbers.

- [`op_ndim()`](https://keras3.posit.co/reference/op_ndim.md) : Return
  the number of dimensions of a tensor.

- [`op_negative()`](https://keras3.posit.co/reference/op_negative.md) :
  Numerical negative, element-wise.

- [`op_nonzero()`](https://keras3.posit.co/reference/op_nonzero.md) :
  Return the indices of the elements that are non-zero.

- [`op_not_equal()`](https://keras3.posit.co/reference/op_not_equal.md)
  :

  Return `(x1 != x2)` element-wise.

- [`op_ones()`](https://keras3.posit.co/reference/op_ones.md) : Return a
  new tensor of given shape and type, filled with ones.

- [`op_ones_like()`](https://keras3.posit.co/reference/op_ones_like.md)
  :

  Return a tensor of ones with the same shape and type of `x`.

- [`op_outer()`](https://keras3.posit.co/reference/op_outer.md) :
  Compute the outer product of two vectors.

- [`op_pad()`](https://keras3.posit.co/reference/op_pad.md) : Pad a
  tensor.

- [`op_power()`](https://keras3.posit.co/reference/op_power.md) : First
  tensor elements raised to powers from second tensor, element-wise.

- [`op_prod()`](https://keras3.posit.co/reference/op_prod.md) : Return
  the product of tensor elements over a given axis.

- [`op_quantile()`](https://keras3.posit.co/reference/op_quantile.md) :
  Compute the q-th quantile(s) of the data along the specified axis.

- [`op_ravel()`](https://keras3.posit.co/reference/op_ravel.md) : Return
  a contiguous flattened tensor.

- [`op_real()`](https://keras3.posit.co/reference/op_real.md) : Return
  the real part of the complex argument.

- [`op_reciprocal()`](https://keras3.posit.co/reference/op_reciprocal.md)
  : Return the reciprocal of the argument, element-wise.

- [`op_repeat()`](https://keras3.posit.co/reference/op_repeat.md) :
  Repeat each element of a tensor after themselves.

- [`op_reshape()`](https://keras3.posit.co/reference/op_reshape.md) :
  Gives a new shape to a tensor without changing its data.

- [`op_right_shift()`](https://keras3.posit.co/reference/op_right_shift.md)
  : Shift the bits of an integer to the right.

- [`op_roll()`](https://keras3.posit.co/reference/op_roll.md) : Roll
  tensor elements along a given axis.

- [`op_rot90()`](https://keras3.posit.co/reference/op_rot90.md) : Rotate
  an array by 90 degrees in the plane specified by axes.

- [`op_round()`](https://keras3.posit.co/reference/op_round.md) : Evenly
  round to the given number of decimals.

- [`op_saturate_cast()`](https://keras3.posit.co/reference/op_saturate_cast.md)
...
- [`op_sign()`](https://keras3.posit.co/reference/op_sign.md) :
...
- [`op_sin()`](https://keras3.posit.co/reference/op_sin.md) :
  Trigonometric sine, element-wise.

- [`op_sinh()`](https://keras3.posit.co/reference/op_sinh.md) :
  Hyperbolic sine, element-wise.

- [`op_size()`](https://keras3.posit.co/reference/op_size.md) : Return
  the number of elements in a tensor.

- [`op_sort()`](https://keras3.posit.co/reference/op_sort.md) :

  Sorts the elements of `x` along a given axis in ascending order.

- [`op_split()`](https://keras3.posit.co/reference/op_split.md) : Split
  a tensor into chunks.

- [`op_sqrt()`](https://keras3.posit.co/reference/op_sqrt.md) : Return
  the non-negative square root of a tensor, element-wise.

- [`op_square()`](https://keras3.posit.co/reference/op_square.md) :
  Return the element-wise square of the input.

- [`op_squeeze()`](https://keras3.posit.co/reference/op_squeeze.md) :

  Remove axes of length one from `x`.

- [`op_stack()`](https://keras3.posit.co/reference/op_stack.md) : Join a
  sequence of tensors along a new axis.

- [`op_std()`](https://keras3.posit.co/reference/op_std.md) : Compute
  the standard deviation along the specified axis.

- [`op_subtract()`](https://keras3.posit.co/reference/op_subtract.md) :
  Subtract arguments element-wise.

- [`op_sum()`](https://keras3.posit.co/reference/op_sum.md) : Sum of a
  tensor over the given axes.

- [`op_swapaxes()`](https://keras3.posit.co/reference/op_swapaxes.md) :
  Interchange two axes of a tensor.

- [`op_take()`](https://keras3.posit.co/reference/op_take.md) : Take
  elements from a tensor along an axis.

- [`op_take_along_axis()`](https://keras3.posit.co/reference/op_take_along_axis.md)
  :

  Select values from `x` at the 1-D `indices` along the given axis.

- [`op_tan()`](https://keras3.posit.co/reference/op_tan.md) : Compute
  tangent, element-wise.

- [`op_tanh()`](https://keras3.posit.co/reference/op_tanh.md) :
  Hyperbolic tangent, element-wise.

- [`op_tensordot()`](https://keras3.posit.co/reference/op_tensordot.md)
  : Compute the tensor dot product along specified axes.

- [`op_tile()`](https://keras3.posit.co/reference/op_tile.md) :

  Repeat `x` the number of times given by `repeats`.

- [`op_trace()`](https://keras3.posit.co/reference/op_trace.md) : Return
  the sum along diagonals of the tensor.

- [`op_transpose()`](https://keras3.posit.co/reference/op_transpose.md)
  :

  Returns a tensor with `axes` transposed.

- [`op_tri()`](https://keras3.posit.co/reference/op_tri.md) : Return a
  tensor with ones at and below a diagonal and zeros elsewhere.

- [`op_tril()`](https://keras3.posit.co/reference/op_tril.md) : Return
  lower triangle of a tensor.

- [`op_triu()`](https://keras3.posit.co/reference/op_triu.md) : Return
  upper triangle of a tensor.

- [`op_trunc()`](https://keras3.posit.co/reference/op_trunc.md) : Return
  the truncated value of the input, element-wise.

- [`op_var()`](https://keras3.posit.co/reference/op_var.md) : Compute
  the variance along the specified axes.

- [`op_vdot()`](https://keras3.posit.co/reference/op_vdot.md) : Return
...
- [`op_vstack()`](https://keras3.posit.co/reference/op_vstack.md) :
  Stack tensors in sequence vertically (row wise).

- [`op_where()`](https://keras3.posit.co/reference/op_where.md) :

  Return elements chosen from `x1` or `x2` depending on `condition`.

- [`op_zeros()`](https://keras3.posit.co/reference/op_zeros.md) : Return
  a new tensor of given shape and type, filled with zeros.

- [`op_zeros_like()`](https://keras3.posit.co/reference/op_zeros_like.md)
  :
...
- [`op_average_pool()`](https://keras3.posit.co/reference/op_average_pool.md)
...
- [`op_binary_crossentropy()`](https://keras3.posit.co/reference/op_binary_crossentropy.md)
  : Computes binary cross-entropy loss between target and output tensor.

- [`op_categorical_crossentropy()`](https://keras3.posit.co/reference/op_categorical_crossentropy.md)
...
- [`op_conv()`](https://keras3.posit.co/reference/op_conv.md) : General
  N-D convolution.
...
- [`op_depthwise_conv()`](https://keras3.posit.co/reference/op_depthwise_conv.md)
...
- [`op_elu()`](https://keras3.posit.co/reference/op_elu.md) :
  Exponential Linear Unit activation function.

- [`op_gelu()`](https://keras3.posit.co/reference/op_gelu.md) : Gaussian
  Error Linear Unit (GELU) activation function.

- [`op_glu()`](https://keras3.posit.co/reference/op_glu.md) : Gated
  Linear Unit (GLU) activation function.

- [`op_hard_shrink()`](https://keras3.posit.co/reference/op_hard_shrink.md)
  : Hard Shrink activation function.

- [`op_hard_sigmoid()`](https://keras3.posit.co/reference/op_hard_sigmoid.md)
  : Hard sigmoid activation function.

- [`op_hard_silu()`](https://keras3.posit.co/reference/op_hard_silu.md)
  [`op_hard_swish()`](https://keras3.posit.co/reference/op_hard_silu.md)
...
- [`op_leaky_relu()`](https://keras3.posit.co/reference/op_leaky_relu.md)
  : Leaky version of a Rectified Linear Unit activation function.

- [`op_log_sigmoid()`](https://keras3.posit.co/reference/op_log_sigmoid.md)
  : Logarithm of the sigmoid activation function.

- [`op_log_softmax()`](https://keras3.posit.co/reference/op_log_softmax.md)
  : Log-softmax activation function.

- [`op_max_pool()`](https://keras3.posit.co/reference/op_max_pool.md) :
  Max pooling operation.

- [`op_moments()`](https://keras3.posit.co/reference/op_moments.md) :
...
- [`op_psnr()`](https://keras3.posit.co/reference/op_psnr.md) : Peak
  Signal-to-Noise Ratio (PSNR) function.

- [`op_relu()`](https://keras3.posit.co/reference/op_relu.md) :
  Rectified linear unit activation function.

- [`op_relu6()`](https://keras3.posit.co/reference/op_relu6.md) :
  Rectified linear unit activation function with upper bound of 6.

- [`op_rms_normalization()`](https://keras3.posit.co/reference/op_rms_normalization.md)
  :

  Performs Root Mean Square (RMS) normalization on `x`.

- [`op_selu()`](https://keras3.posit.co/reference/op_selu.md) : Scaled
  Exponential Linear Unit (SELU) activation function.

- [`op_separable_conv()`](https://keras3.posit.co/reference/op_separable_conv.md)
  : General N-D separable convolution.

- [`op_sigmoid()`](https://keras3.posit.co/reference/op_sigmoid.md) :
  Sigmoid activation function.

- [`op_silu()`](https://keras3.posit.co/reference/op_silu.md) : Sigmoid
  Linear Unit (SiLU) activation function, also known as Swish.

- [`op_soft_shrink()`](https://keras3.posit.co/reference/op_soft_shrink.md)
  : Soft Shrink activation function.

- [`op_softmax()`](https://keras3.posit.co/reference/op_softmax.md) :
  Softmax activation function.

- [`op_softplus()`](https://keras3.posit.co/reference/op_softplus.md) :
  Softplus activation function.

- [`op_softsign()`](https://keras3.posit.co/reference/op_softsign.md) :
  Softsign activation function.

- [`op_sparse_categorical_crossentropy()`](https://keras3.posit.co/reference/op_sparse_categorical_crossentropy.md)
...
- [`op_det()`](https://keras3.posit.co/reference/op_det.md) : Computes
  the determinant of a square tensor.

- [`op_eig()`](https://keras3.posit.co/reference/op_eig.md) : Computes
  the eigenvalues and eigenvectors of a square matrix.

- [`op_eigh()`](https://keras3.posit.co/reference/op_eigh.md) : Computes
  the eigenvalues and eigenvectors of a complex Hermitian.

- [`op_inv()`](https://keras3.posit.co/reference/op_inv.md) : Computes
...
- [`op_norm()`](https://keras3.posit.co/reference/op_norm.md) : Matrix
  or vector norm.
...
- [`op_svd()`](https://keras3.posit.co/reference/op_svd.md) : Computes
...
- [`loss_ctc()`](https://keras3.posit.co/reference/loss_ctc.md) : CTC
...
- [`activation_hard_sigmoid()`](https://keras3.posit.co/reference/activation_hard_sigmoid.md)
  : Hard sigmoid activation function.
- [`activation_hard_silu()`](https://keras3.posit.co/reference/activation_hard_silu.md)
  [`activation_hard_swish()`](https://keras3.posit.co/reference/activation_hard_silu.md)
  : Hard SiLU activation function, also known as Hard Swish.
...
- [`dataset_imdb()`](https://keras3.posit.co/reference/dataset_imdb.md)
  [`dataset_imdb_word_index()`](https://keras3.posit.co/reference/dataset_imdb.md)
...
- [`dataset_reuters()`](https://keras3.posit.co/reference/dataset_reuters.md)
  [`dataset_reuters_word_index()`](https://keras3.posit.co/reference/dataset_reuters.md)
...
- [`shape()`](https://keras3.posit.co/reference/shape.md)
  [`format(`*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`print(`*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`` `[`( ``*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`as.integer(`*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`Summary(`*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`as.list(`*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`` `==`( ``*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
  [`` `!=`( ``*`<keras_shape>`*`)`](https://keras3.posit.co/reference/shape.md)
...
- [`keras`](https://keras3.posit.co/reference/keras.md) : Main Keras
  module
...
- [`zip_lists()`](https://keras3.posit.co/reference/zip_lists.md) : Zip
  lists
...
- [`newaxis`](https://keras3.posit.co/reference/newaxis.md) : New axis
...
- [`get_custom_objects()`](https://keras3.posit.co/reference/get_custom_objects.md)
  [`set_custom_objects()`](https://keras3.posit.co/reference/get_custom_objects.md)
...
- [`application_convnext_base()`](https://keras3.posit.co/reference/application_convnext_base.md)
  : Instantiates the ConvNeXtBase architecture.
- [`application_convnext_large()`](https://keras3.posit.co/reference/application_convnext_large.md)
  : Instantiates the ConvNeXtLarge architecture.
- [`application_convnext_small()`](https://keras3.posit.co/reference/application_convnext_small.md)
  : Instantiates the ConvNeXtSmall architecture.
- [`application_convnext_tiny()`](https://keras3.posit.co/reference/application_convnext_tiny.md)
  : Instantiates the ConvNeXtTiny architecture.
- [`application_convnext_xlarge()`](https://keras3.posit.co/reference/application_convnext_xlarge.md)
  : Instantiates the ConvNeXtXLarge architecture.

### Densenet Applications

- [`application_densenet121()`](https://keras3.posit.co/reference/application_densenet121.md)
  : Instantiates the Densenet121 architecture.
- [`application_densenet169()`](https://keras3.posit.co/reference/application_densenet169.md)
  : Instantiates the Densenet169 architecture.
- [`application_densenet201()`](https://keras3.posit.co/reference/application_densenet201.md)
  : Instantiates the Densenet201 architecture.

### EfficientNet Applications

- [`application_efficientnet_b0()`](https://keras3.posit.co/reference/application_efficientnet_b0.md)
  : Instantiates the EfficientNetB0 architecture.
- [`application_efficientnet_b1()`](https://keras3.posit.co/reference/application_efficientnet_b1.md)
  : Instantiates the EfficientNetB1 architecture.
- [`application_efficientnet_b2()`](https://keras3.posit.co/reference/application_efficientnet_b2.md)
  : Instantiates the EfficientNetB2 architecture.
- [`application_efficientnet_b3()`](https://keras3.posit.co/reference/application_efficientnet_b3.md)
  : Instantiates the EfficientNetB3 architecture.
- [`application_efficientnet_b4()`](https://keras3.posit.co/reference/application_efficientnet_b4.md)
  : Instantiates the EfficientNetB4 architecture.
- [`application_efficientnet_b5()`](https://keras3.posit.co/reference/application_efficientnet_b5.md)
  : Instantiates the EfficientNetB5 architecture.
- [`application_efficientnet_b6()`](https://keras3.posit.co/reference/application_efficientnet_b6.md)
  : Instantiates the EfficientNetB6 architecture.
- [`application_efficientnet_b7()`](https://keras3.posit.co/reference/application_efficientnet_b7.md)
  : Instantiates the EfficientNetB7 architecture.
- [`application_efficientnet_v2b0()`](https://keras3.posit.co/reference/application_efficientnet_v2b0.md)
  : Instantiates the EfficientNetV2B0 architecture.
- [`application_efficientnet_v2b1()`](https://keras3.posit.co/reference/application_efficientnet_v2b1.md)
  : Instantiates the EfficientNetV2B1 architecture.
- [`application_efficientnet_v2b2()`](https://keras3.posit.co/reference/application_efficientnet_v2b2.md)
  : Instantiates the EfficientNetV2B2 architecture.
- [`application_efficientnet_v2b3()`](https://keras3.posit.co/reference/application_efficientnet_v2b3.md)
  : Instantiates the EfficientNetV2B3 architecture.
- [`application_efficientnet_v2l()`](https://keras3.posit.co/reference/application_efficientnet_v2l.md)
  : Instantiates the EfficientNetV2L architecture.
- [`application_efficientnet_v2m()`](https://keras3.posit.co/reference/application_efficientnet_v2m.md)
  : Instantiates the EfficientNetV2M architecture.
- [`application_efficientnet_v2s()`](https://keras3.posit.co/reference/application_efficientnet_v2s.md)
  : Instantiates the EfficientNetV2S architecture.

### Inception Applications

- [`application_inception_resnet_v2()`](https://keras3.posit.co/reference/application_inception_resnet_v2.md)
  : Instantiates the Inception-ResNet v2 architecture.
- [`application_inception_v3()`](https://keras3.posit.co/reference/application_inception_v3.md)
  : Instantiates the Inception v3 architecture.

### MobileNet Applications

- [`application_mobilenet()`](https://keras3.posit.co/reference/application_mobilenet.md)
  : Instantiates the MobileNet architecture.
- [`application_mobilenet_v2()`](https://keras3.posit.co/reference/application_mobilenet_v2.md)
  : Instantiates the MobileNetV2 architecture.
- [`application_mobilenet_v3_large()`](https://keras3.posit.co/reference/application_mobilenet_v3_large.md)
  : Instantiates the MobileNetV3Large architecture.
- [`application_mobilenet_v3_small()`](https://keras3.posit.co/reference/application_mobilenet_v3_small.md)
  : Instantiates the MobileNetV3Small architecture.

### NASNet Applications

- [`application_nasnet_large()`](https://keras3.posit.co/reference/application_nasnet_large.md)
  : Instantiates a NASNet model in ImageNet mode.
- [`application_nasnet_mobile()`](https://keras3.posit.co/reference/application_nasnet_mobile.md)
  : Instantiates a Mobile NASNet model in ImageNet mode.

### ResNet Applications

- [`application_resnet101()`](https://keras3.posit.co/reference/application_resnet101.md)
  : Instantiates the ResNet101 architecture.
- [`application_resnet101_v2()`](https://keras3.posit.co/reference/application_resnet101_v2.md)
  : Instantiates the ResNet101V2 architecture.
- [`application_resnet152()`](https://keras3.posit.co/reference/application_resnet152.md)
  : Instantiates the ResNet152 architecture.
- [`application_resnet152_v2()`](https://keras3.posit.co/reference/application_resnet152_v2.md)
  : Instantiates the ResNet152V2 architecture.
- [`application_resnet50()`](https://keras3.posit.co/reference/application_resnet50.md)
  : Instantiates the ResNet50 architecture.
- [`application_resnet50_v2()`](https://keras3.posit.co/reference/application_resnet50_v2.md)
  : Instantiates the ResNet50V2 architecture.

### VGG Applications

- [`application_vgg16()`](https://keras3.posit.co/reference/application_vgg16.md)
  : Instantiates the VGG16 model.
- [`application_vgg19()`](https://keras3.posit.co/reference/application_vgg19.md)
  : Instantiates the VGG19 model.

### Xception Applications

- [`application_xception()`](https://keras3.posit.co/reference/application_xception.md)
