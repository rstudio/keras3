...
[`adapt()`](https://keras3.posit.co/reference/adapt.md).
[`adapt()`](https://keras3.posit.co/reference/adapt.md) will compute the
mean and variance of the data and store them as the layer's weights.
[`adapt()`](https://keras3.posit.co/reference/adapt.md) should be called
before [`fit()`](https://generics.r-lib.org/reference/fit.html),
