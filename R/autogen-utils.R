...
#' @eval readLines("man-roxygen/clear_session/roxygen.Rmd")
clear_session <-
function ()
{
...
#' @eval readLines("man-roxygen/layer_feature_space/roxygen.Rmd")
layer_feature_space <-
...
#' @eval readLines("man-roxygen/get_source_inputs/roxygen.Rmd")
get_source_inputs <-
function (tensor)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-roxygen/get_custom_objects/roxygen.Rmd")
get_custom_objects <-
function ()
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-roxygen/get_registered_name/roxygen.Rmd")
get_registered_name <-
function (obj)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-roxygen/get_registered_object/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/pack_x_y_sample_weight/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/unpack_x_y_sample_weight/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/audio_dataset_from_directory/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/split_dataset/roxygen.Rmd")
split_dataset <-
...
#' @eval readLines("man-roxygen/get_file/roxygen.Rmd")
get_file <-
...
#' @eval readLines("man-roxygen/image_dataset_from_directory/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/image_array_save/roxygen.Rmd")
image_array_save <-
...
#' @eval readLines("man-roxygen/image_from_array/roxygen.Rmd")
image_from_array <-
...
#' @eval readLines("man-roxygen/image_load/roxygen.Rmd")
image_load <-
...
#' @eval readLines("man-roxygen/image_to_array/roxygen.Rmd")
image_to_array <-
...
#' @eval readLines("man-roxygen/model_to_dot/roxygen.Rmd")
model_to_dot <-
...
#' @eval readLines("man-roxygen/normalize/roxygen.Rmd")
normalize <-
...
#' @eval readLines("man-roxygen/to_categorical/roxygen.Rmd")
to_categorical <-
...
#' @eval readLines("man-roxygen/set_random_seed/roxygen.Rmd")
set_random_seed <-
function (seed)
{
...
#' @eval readLines("man-roxygen/pad_sequences/roxygen.Rmd")
pad_sequences <-
...
#' @eval readLines("man-roxygen/text_dataset_from_directory/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/timeseries_dataset_from_array/roxygen.Rmd")
