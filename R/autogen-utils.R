...
#' @eval readLines("man-src/clear_session/2-translated.Rmd")
clear_session <-
function ()
{
...
#' @eval readLines("man-src/layer_feature_space/2-translated.Rmd")
layer_feature_space <-
...
#' @eval readLines("man-src/get_source_inputs/2-translated.Rmd")
get_source_inputs <-
function (tensor)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/get_custom_objects/2-translated.Rmd")
get_custom_objects <-
function ()
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/get_registered_name/2-translated.Rmd")
get_registered_name <-
function (obj)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/get_registered_object/2-translated.Rmd")
...
#' @eval readLines("man-src/pack_x_y_sample_weight/2-translated.Rmd")
...
#' @eval readLines("man-src/unpack_x_y_sample_weight/2-translated.Rmd")
...
#' @eval readLines("man-src/audio_dataset_from_directory/2-translated.Rmd")
...
#' @eval readLines("man-src/split_dataset/2-translated.Rmd")
split_dataset <-
...
#' @eval readLines("man-src/get_file/2-translated.Rmd")
get_file <-
...
#' @eval readLines("man-src/image_dataset_from_directory/2-translated.Rmd")
...
#' @eval readLines("man-src/image_array_save/2-translated.Rmd")
image_array_save <-
...
#' @eval readLines("man-src/image_from_array/2-translated.Rmd")
image_from_array <-
...
#' @eval readLines("man-src/image_load/2-translated.Rmd")
image_load <-
...
#' @eval readLines("man-src/image_to_array/2-translated.Rmd")
image_to_array <-
...
#' @eval readLines("man-src/model_to_dot/2-translated.Rmd")
model_to_dot <-
...
#' @eval readLines("man-src/normalize/2-translated.Rmd")
normalize <-
...
#' @eval readLines("man-src/to_categorical/2-translated.Rmd")
to_categorical <-
...
#' @eval readLines("man-src/set_random_seed/2-translated.Rmd")
set_random_seed <-
function (seed)
{
...
#' @eval readLines("man-src/pad_sequences/2-translated.Rmd")
pad_sequences <-
...
#' @eval readLines("man-src/text_dataset_from_directory/2-translated.Rmd")
...
#' @eval readLines("man-src/timeseries_dataset_from_array/2-translated.Rmd")
