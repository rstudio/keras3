...
#' @eval readLines("man-src/layer_add/roxygen.Rmd")
layer_add <-
function (inputs, ...)
{
...
#' @eval readLines("man-src/layer_average/roxygen.Rmd")
layer_average <-
function (inputs, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_concatenate/roxygen.Rmd")
layer_concatenate <-
...
#' @eval readLines("man-src/layer_dot/roxygen.Rmd")
layer_dot <-
...
#' @eval readLines("man-src/layer_maximum/roxygen.Rmd")
layer_maximum <-
function (inputs, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_minimum/roxygen.Rmd")
layer_minimum <-
function (inputs, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_multiply/roxygen.Rmd")
layer_multiply <-
function (inputs, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_subtract/roxygen.Rmd")
layer_subtract <-
function (inputs, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
