...
#' @eval readLines("man-src/metric_binary_focal_crossentropy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_categorical_focal_crossentropy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_huber/2-translated.Rmd")
metric_huber <-
...
#' @eval readLines("man-src/metric_log_cosh/2-translated.Rmd")
metric_log_cosh <-
...
#' @eval readLines("man-src/metric_binary_accuracy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_categorical_accuracy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_sparse_categorical_accuracy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_sparse_top_k_categorical_accuracy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_top_k_categorical_accuracy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_auc/2-translated.Rmd")
metric_auc <-
...
#' @eval readLines("man-src/metric_false_negatives/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_false_positives/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_precision/2-translated.Rmd")
metric_precision <-
...
#' @eval readLines("man-src/metric_precision_at_recall/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_recall/2-translated.Rmd")
metric_recall <-
function (..., thresholds = NULL, top_k = NULL, class_id = NULL,
    name = NULL, dtype = NULL)
{
...
#' @eval readLines("man-src/metric_recall_at_precision/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_sensitivity_at_specificity/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_specificity_at_sensitivity/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_true_negatives/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_true_positives/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_f1_score/2-translated.Rmd")
metric_f1_score <-
...
#' @eval readLines("man-src/metric_fbeta_score/2-translated.Rmd")
metric_fbeta_score <-
...
#' @eval readLines("man-src/metric_categorical_hinge/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_hinge/2-translated.Rmd")
metric_hinge <-
...
#' @eval readLines("man-src/metric_squared_hinge/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_binary_iou/2-translated.Rmd")
metric_binary_iou <-
...
#' @eval readLines("man-src/metric_iou/2-translated.Rmd")
metric_iou <-
...
#' @eval readLines("man-src/metric_mean_iou/2-translated.Rmd")
metric_mean_iou <-
...
#' @eval readLines("man-src/metric_one_hot_iou/2-translated.Rmd")
metric_one_hot_iou <-
function (..., num_classes, target_class_ids, name = NULL, dtype = NULL,
...
#' @eval readLines("man-src/metric_one_hot_mean_iou/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_binary_crossentropy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_categorical_crossentropy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_kl_divergence/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_poisson/2-translated.Rmd")
metric_poisson <-
...
#' @eval readLines("man-src/metric_sparse_categorical_crossentropy/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_mean/2-translated.Rmd")
metric_mean <-
...
#' @eval readLines("man-src/metric_mean_wrapper/2-translated.Rmd")
metric_mean_wrapper <-
...
#' @eval readLines("man-src/metric_sum/2-translated.Rmd")
metric_sum <-
...
#' @eval readLines("man-src/metric_cosine_similarity/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_log_cosh_error/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_mean_absolute_error/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_mean_absolute_percentage_error/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_mean_squared_error/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_mean_squared_logarithmic_error/2-translated.Rmd")
...
#' @eval readLines("man-src/metric_r2_score/2-translated.Rmd")
metric_r2_score <-
...
#' @eval readLines("man-src/metric_root_mean_squared_error/2-translated.Rmd")
