...
#' @eval readLines("man-src/metric_binary_focal_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_categorical_focal_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_huber/roxygen.Rmd")
metric_huber <-
...
#' @eval readLines("man-src/metric_log_cosh/roxygen.Rmd")
metric_log_cosh <-
...
#' @eval readLines("man-src/metric_binary_accuracy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_categorical_accuracy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_sparse_categorical_accuracy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_sparse_top_k_categorical_accuracy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_top_k_categorical_accuracy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_auc/roxygen.Rmd")
metric_auc <-
...
#' @eval readLines("man-src/metric_false_negatives/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_false_positives/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_precision/roxygen.Rmd")
metric_precision <-
...
#' @eval readLines("man-src/metric_precision_at_recall/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_recall/roxygen.Rmd")
metric_recall <-
function (..., thresholds = NULL, top_k = NULL, class_id = NULL,
    name = NULL, dtype = NULL)
{
...
#' @eval readLines("man-src/metric_recall_at_precision/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_sensitivity_at_specificity/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_specificity_at_sensitivity/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_true_negatives/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_true_positives/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_f1_score/roxygen.Rmd")
metric_f1_score <-
...
#' @eval readLines("man-src/metric_fbeta_score/roxygen.Rmd")
metric_fbeta_score <-
...
#' @eval readLines("man-src/metric_categorical_hinge/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_hinge/roxygen.Rmd")
metric_hinge <-
...
#' @eval readLines("man-src/metric_squared_hinge/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_binary_iou/roxygen.Rmd")
metric_binary_iou <-
...
#' @eval readLines("man-src/metric_iou/roxygen.Rmd")
metric_iou <-
...
#' @eval readLines("man-src/metric_mean_iou/roxygen.Rmd")
metric_mean_iou <-
...
#' @eval readLines("man-src/metric_one_hot_iou/roxygen.Rmd")
metric_one_hot_iou <-
function (..., num_classes, target_class_ids, name = NULL, dtype = NULL,
...
#' @eval readLines("man-src/metric_one_hot_mean_iou/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_binary_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_categorical_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_kl_divergence/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_poisson/roxygen.Rmd")
metric_poisson <-
...
#' @eval readLines("man-src/metric_sparse_categorical_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_mean/roxygen.Rmd")
metric_mean <-
...
#' @eval readLines("man-src/metric_mean_wrapper/roxygen.Rmd")
metric_mean_wrapper <-
...
#' @eval readLines("man-src/metric_sum/roxygen.Rmd")
metric_sum <-
...
#' @eval readLines("man-src/metric_cosine_similarity/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_log_cosh_error/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_mean_absolute_error/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_mean_absolute_percentage_error/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_mean_squared_error/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_mean_squared_logarithmic_error/roxygen.Rmd")
...
#' @eval readLines("man-src/metric_r2_score/roxygen.Rmd")
metric_r2_score <-
...
#' @eval readLines("man-src/metric_root_mean_squared_error/roxygen.Rmd")
