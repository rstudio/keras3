...
#' @eval readLines("man-src/activation_elu/roxygen.Rmd")
activation_elu <-
...
#' @eval readLines("man-src/activation_exponential/roxygen.Rmd")
...
#' @eval readLines("man-src/activation_gelu/roxygen.Rmd")
activation_gelu <-
...
#' @eval readLines("man-src/activation_hard_sigmoid/roxygen.Rmd")
...
#' @eval readLines("man-src/activation_leaky_relu/roxygen.Rmd")
...
#' @eval readLines("man-src/activation_linear/roxygen.Rmd")
activation_linear <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_log_softmax/roxygen.Rmd")
...
#' @eval readLines("man-src/activation_mish/roxygen.Rmd")
activation_mish <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_relu/roxygen.Rmd")
activation_relu <-
...
#' @eval readLines("man-src/activation_relu6/roxygen.Rmd")
activation_relu6 <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_selu/roxygen.Rmd")
activation_selu <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_sigmoid/roxygen.Rmd")
activation_sigmoid <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_silu/roxygen.Rmd")
activation_silu <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_softmax/roxygen.Rmd")
activation_softmax <-
structure(function (x, axis = -1L)
{
    args <- capture_args2(list(axis = as_axis))
...
#' @eval readLines("man-src/activation_softplus/roxygen.Rmd")
activation_softplus <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_softsign/roxygen.Rmd")
activation_softsign <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_tanh/roxygen.Rmd")
activation_tanh <-
structure(function (x)
{
    args <- capture_args2(NULL)
