...
#' @eval readLines("man-src/activation_elu/2-translated.Rmd")
activation_elu <-
...
#' @eval readLines("man-src/activation_exponential/2-translated.Rmd")
...
#' @eval readLines("man-src/activation_gelu/2-translated.Rmd")
activation_gelu <-
...
#' @eval readLines("man-src/activation_hard_sigmoid/2-translated.Rmd")
...
#' @eval readLines("man-src/activation_leaky_relu/2-translated.Rmd")
...
#' @eval readLines("man-src/activation_linear/2-translated.Rmd")
activation_linear <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_log_softmax/2-translated.Rmd")
...
#' @eval readLines("man-src/activation_mish/2-translated.Rmd")
activation_mish <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_relu/2-translated.Rmd")
activation_relu <-
...
#' @eval readLines("man-src/activation_relu6/2-translated.Rmd")
activation_relu6 <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_selu/2-translated.Rmd")
activation_selu <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_sigmoid/2-translated.Rmd")
activation_sigmoid <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_silu/2-translated.Rmd")
activation_silu <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_softmax/2-translated.Rmd")
activation_softmax <-
structure(function (x, axis = -1L)
{
    args <- capture_args2(list(axis = as_axis))
...
#' @eval readLines("man-src/activation_softplus/2-translated.Rmd")
activation_softplus <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_softsign/2-translated.Rmd")
activation_softsign <-
structure(function (x)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/activation_tanh/2-translated.Rmd")
activation_tanh <-
structure(function (x)
{
    args <- capture_args2(NULL)
