...
#' @eval readLines("man-src/layer_dense/roxygen.Rmd")
layer_dense <-
...
#' @eval readLines("man-src/layer_einsum_dense/roxygen.Rmd")
layer_einsum_dense <-
...
#' @eval readLines("man-src/layer_embedding/roxygen.Rmd")
layer_embedding <-
...
#' @eval readLines("man-src/layer_identity/roxygen.Rmd")
layer_identity <-
function (object, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_input/roxygen.Rmd")
layer_input <-
...
#' @eval readLines("man-src/layer_lambda/roxygen.Rmd")
layer_lambda <-
...
#' @eval readLines("man-src/layer_masking/roxygen.Rmd")
layer_masking <-
