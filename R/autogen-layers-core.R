...
#' @eval readLines("man-src/layer_dense/2-translated.Rmd")
layer_dense <-
...
#' @eval readLines("man-src/layer_einsum_dense/2-translated.Rmd")
layer_einsum_dense <-
...
#' @eval readLines("man-src/layer_embedding/2-translated.Rmd")
layer_embedding <-
...
#' @eval readLines("man-src/layer_identity/2-translated.Rmd")
layer_identity <-
function (object, ...)
{
    args <- capture_args2(list(input_shape = normalize_shape,
...
#' @eval readLines("man-src/layer_input/2-translated.Rmd")
layer_input <-
...
#' @eval readLines("man-src/layer_lambda/2-translated.Rmd")
layer_lambda <-
...
#' @eval readLines("man-src/layer_masking/2-translated.Rmd")
layer_masking <-
