...
#' @eval readLines("man-src/layer_category_encoding/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_center_crop/roxygen.Rmd")
layer_center_crop <-
...
#' @eval readLines("man-src/layer_discretization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_hashed_crossing/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_hashing/roxygen.Rmd")
layer_hashing <-
...
#' @eval readLines("man-src/layer_integer_lookup/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_normalization/roxygen.Rmd")
layer_normalization <-
...
#' @eval readLines("man-src/layer_random_brightness/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_random_contrast/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_random_crop/roxygen.Rmd")
layer_random_crop <-
...
#' @eval readLines("man-src/layer_random_flip/roxygen.Rmd")
layer_random_flip <-
...
#' @eval readLines("man-src/layer_random_rotation/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_random_translation/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_random_zoom/roxygen.Rmd")
layer_random_zoom <-
...
#' @eval readLines("man-src/layer_rescaling/roxygen.Rmd")
layer_rescaling <-
...
#' @eval readLines("man-src/layer_resizing/roxygen.Rmd")
layer_resizing <-
...
#' @eval readLines("man-src/layer_string_lookup/roxygen.Rmd")
layer_string_lookup <-
function (object, max_tokens = NULL, num_oov_indices = 1L, mask_token = NULL,
...
#' @eval readLines("man-src/layer_text_vectorization/roxygen.Rmd")
