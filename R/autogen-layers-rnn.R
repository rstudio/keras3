...
#' @eval readLines("man-src/layer_bidirectional/roxygen.Rmd")
layer_bidirectional <-
...
#' @eval readLines("man-src/layer_conv_lstm_1d/roxygen.Rmd")
layer_conv_lstm_1d <-
...
#' @eval readLines("man-src/layer_conv_lstm_2d/roxygen.Rmd")
layer_conv_lstm_2d <-
function (object, filters, kernel_size, strides = 1L, padding = "valid",
    data_format = NULL, dilation_rate = 1L, activation = "tanh",
    recurrent_activation = "sigmoid", use_bias = TRUE, kernel_initializer = "glorot_uniform",
...
#' @eval readLines("man-src/layer_conv_lstm_3d/roxygen.Rmd")
layer_conv_lstm_3d <-
function (object, filters, kernel_size, strides = 1L, padding = "valid",
    data_format = NULL, dilation_rate = 1L, activation = "tanh",
    recurrent_activation = "sigmoid", use_bias = TRUE, kernel_initializer = "glorot_uniform",
...
#' @eval readLines("man-src/layer_gru/roxygen.Rmd")
layer_gru <-
...
#' @eval readLines("man-src/layer_gru_cell/roxygen.Rmd")
layer_gru_cell <-
...
#' @eval readLines("man-src/layer_lstm/roxygen.Rmd")
layer_lstm <-
function (object, units, activation = "tanh", recurrent_activation = "sigmoid",
    use_bias = TRUE, kernel_initializer = "glorot_uniform", recurrent_initializer = "orthogonal",
...
#' @eval readLines("man-src/layer_lstm_cell/roxygen.Rmd")
layer_lstm_cell <-
function (units, activation = "tanh", recurrent_activation = "sigmoid",
    use_bias = TRUE, kernel_initializer = "glorot_uniform", recurrent_initializer = "orthogonal",
    bias_initializer = "zeros", unit_forget_bias = TRUE, kernel_regularizer = NULL,
...
#' @eval readLines("man-src/layer_rnn/roxygen.Rmd")
layer_rnn <-
...
#' @eval readLines("man-src/layer_simple_rnn/roxygen.Rmd")
layer_simple_rnn <-
...
#' @eval readLines("man-src/layer_simple_rnn_cell/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_stacked_rnn_cells/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_time_distributed/roxygen.Rmd")
