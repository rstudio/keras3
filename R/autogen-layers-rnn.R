...
"man-src/bidirectional.Rmd" # |>file.edit() # or cmd+click to edit man page
"man-src/bidirectional/0-upstream.md" # view the upstream doc
#' @eval readLines("man-src/bidirectional/3-rendered.md")
bidirectional <-
