...
"man-src/layer_bidirectional/1-formatted.md" # view the upstream doc
"man-src/layer_bidirectional/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_bidirectional/3-rendered.md")
layer_bidirectional <-
...
"man-src/layer_conv_lstm_1d/1-formatted.md" # view the upstream doc
"man-src/layer_conv_lstm_1d/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_conv_lstm_1d/3-rendered.md")
layer_conv_lstm_1d <-
...
"man-src/layer_conv_lstm_2d/1-formatted.md" # view the upstream doc
"man-src/layer_conv_lstm_2d/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_conv_lstm_2d/3-rendered.md")
layer_conv_lstm_2d <-
function (object, filters, kernel_size, strides = 1L, padding = "valid",
    data_format = NULL, dilation_rate = 1L, activation = "tanh",
    recurrent_activation = "sigmoid", use_bias = TRUE, kernel_initializer = "glorot_uniform",
...
"man-src/layer_conv_lstm_3d/1-formatted.md" # view the upstream doc
"man-src/layer_conv_lstm_3d/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_conv_lstm_3d/3-rendered.md")
layer_conv_lstm_3d <-
function (object, filters, kernel_size, strides = 1L, padding = "valid",
    data_format = NULL, dilation_rate = 1L, activation = "tanh",
    recurrent_activation = "sigmoid", use_bias = TRUE, kernel_initializer = "glorot_uniform",
...
"man-src/layer_gru/1-formatted.md" # view the upstream doc
"man-src/layer_gru/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_gru/3-rendered.md")
layer_gru <-
...
"man-src/layer_gru_cell/1-formatted.md" # view the upstream doc
"man-src/layer_gru_cell/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_gru_cell/3-rendered.md")
layer_gru_cell <-
...
"man-src/layer_lstm/1-formatted.md" # view the upstream doc
"man-src/layer_lstm/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_lstm/3-rendered.md")
layer_lstm <-
function (object, units, activation = "tanh", recurrent_activation = "sigmoid",
    use_bias = TRUE, kernel_initializer = "glorot_uniform", recurrent_initializer = "orthogonal",
...
"man-src/layer_lstm_cell/1-formatted.md" # view the upstream doc
"man-src/layer_lstm_cell/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_lstm_cell/3-rendered.md")
layer_lstm_cell <-
function (units, activation = "tanh", recurrent_activation = "sigmoid",
    use_bias = TRUE, kernel_initializer = "glorot_uniform", recurrent_initializer = "orthogonal",
    bias_initializer = "zeros", unit_forget_bias = TRUE, kernel_regularizer = NULL,
...
"man-src/layer_rnn/1-formatted.md" # view the upstream doc
"man-src/layer_rnn/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_rnn/3-rendered.md")
layer_rnn <-
...
"man-src/layer_simple_rnn/1-formatted.md" # view the upstream doc
"man-src/layer_simple_rnn/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_simple_rnn/3-rendered.md")
layer_simple_rnn <-
...
"man-src/layer_simple_rnn_cell/1-formatted.md" # view the upstream doc
"man-src/layer_simple_rnn_cell/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_simple_rnn_cell/3-rendered.md")
...
"man-src/layer_stacked_rnn_cells/1-formatted.md" # view the upstream doc
"man-src/layer_stacked_rnn_cells/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_stacked_rnn_cells/3-rendered.md")
...
"man-src/layer_time_distributed/1-formatted.md" # view the upstream doc
"man-src/layer_time_distributed/2-translated.Rmd" # |>file.edit() # or cmd+click to edit man page
#' @eval readLines("man-src/layer_time_distributed/3-rendered.md")
