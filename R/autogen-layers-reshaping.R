...
#' @eval readLines("man-src/layer_cropping_1d/roxygen.Rmd")
layer_cropping_1d <-
...
#' @eval readLines("man-src/layer_cropping_2d/roxygen.Rmd")
layer_cropping_2d <-
...
#' @eval readLines("man-src/layer_cropping_3d/roxygen.Rmd")
layer_cropping_3d <-
...
#' @eval readLines("man-src/layer_flatten/roxygen.Rmd")
layer_flatten <-
...
#' @eval readLines("man-src/layer_permute/roxygen.Rmd")
layer_permute <-
...
#' @eval readLines("man-src/layer_repeat_vector/roxygen.Rmd")
layer_repeat_vector <-
function (object, n, ...)
{
...
#' @eval readLines("man-src/layer_reshape/roxygen.Rmd")
layer_reshape <-
...
#' @eval readLines("man-src/layer_upsampling_1d/roxygen.Rmd")
layer_upsampling_1d <-
...
#' @eval readLines("man-src/layer_upsampling_2d/roxygen.Rmd")
layer_upsampling_2d <-
...
#' @eval readLines("man-src/layer_upsampling_3d/roxygen.Rmd")
layer_upsampling_3d <-
...
#' @eval readLines("man-src/layer_zero_padding_1d/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_zero_padding_2d/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_zero_padding_3d/roxygen.Rmd")
