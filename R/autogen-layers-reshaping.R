...
#' @eval readLines("man-src/layer_cropping_1d/2-translated.Rmd")
layer_cropping_1d <-
...
#' @eval readLines("man-src/layer_cropping_2d/2-translated.Rmd")
layer_cropping_2d <-
...
#' @eval readLines("man-src/layer_cropping_3d/2-translated.Rmd")
layer_cropping_3d <-
...
#' @eval readLines("man-src/layer_flatten/2-translated.Rmd")
layer_flatten <-
...
#' @eval readLines("man-src/layer_permute/2-translated.Rmd")
layer_permute <-
...
#' @eval readLines("man-src/layer_repeat_vector/2-translated.Rmd")
layer_repeat_vector <-
function (object, n, ...)
{
...
#' @eval readLines("man-src/layer_reshape/2-translated.Rmd")
layer_reshape <-
...
#' @eval readLines("man-src/layer_upsampling_1d/2-translated.Rmd")
layer_upsampling_1d <-
...
#' @eval readLines("man-src/layer_upsampling_2d/2-translated.Rmd")
layer_upsampling_2d <-
...
#' @eval readLines("man-src/layer_upsampling_3d/2-translated.Rmd")
layer_upsampling_3d <-
...
#' @eval readLines("man-src/layer_zero_padding_1d/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_zero_padding_2d/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_zero_padding_3d/2-translated.Rmd")
