...
#' @eval readLines("man-src/k_image_affine_transform/2-translated.Rmd")
...
#' @eval readLines("man-src/k_image_extract_patches/2-translated.Rmd")
...
#' @eval readLines("man-src/k_image_map_coordinates/2-translated.Rmd")
...
#' @eval readLines("man-src/k_image_pad_images/2-translated.Rmd")
k_image_pad_images <-
...
#' @eval readLines("man-src/k_image_resize/2-translated.Rmd")
k_image_resize <-
