...
#' @eval readLines("man-src/k_image_affine_transform/roxygen.Rmd")
...
#' @eval readLines("man-src/k_image_extract_patches/roxygen.Rmd")
...
#' @eval readLines("man-src/k_image_map_coordinates/roxygen.Rmd")
...
#' @eval readLines("man-src/k_image_pad_images/roxygen.Rmd")
k_image_pad_images <-
...
#' @eval readLines("man-src/k_image_resize/roxygen.Rmd")
k_image_resize <-
