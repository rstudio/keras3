...
#' @eval readLines("man-src/layer_activation/roxygen.Rmd")
layer_activation <-
...
#' @eval readLines("man-src/layer_activation_elu/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_activation_leaky_relu/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_activation_parametric_relu/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_activation_relu/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_activation_softmax/roxygen.Rmd")
