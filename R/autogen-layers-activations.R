...
#' @eval readLines("man-src/layer_activation/2-translated.Rmd")
layer_activation <-
...
#' @eval readLines("man-src/layer_activation_elu/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_activation_leaky_relu/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_activation_parametric_relu/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_activation_relu/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_activation_softmax/2-translated.Rmd")
