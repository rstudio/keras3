...
#' @eval readLines("man-src/random_categorical/roxygen.Rmd")
random_categorical <-
...
#' @eval readLines("man-src/random_dropout/roxygen.Rmd")
random_dropout <-
...
#' @eval readLines("man-src/random_integer/roxygen.Rmd")
random_integer <-
...
#' @eval readLines("man-src/random_normal/roxygen.Rmd")
random_normal <-
...
#' @eval readLines("man-src/random_shuffle/roxygen.Rmd")
random_shuffle <-
...
#' @eval readLines("man-src/random_truncated_normal/roxygen.Rmd")
...
#' @eval readLines("man-src/random_uniform/roxygen.Rmd")
random_uniform <-
...
#' @eval readLines("man-src/random_seed_generator/roxygen.Rmd")
