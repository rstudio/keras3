...
#' @eval readLines("man-src/random_categorical/2-translated.Rmd")
random_categorical <-
...
#' @eval readLines("man-src/random_dropout/2-translated.Rmd")
random_dropout <-
...
#' @eval readLines("man-src/random_integer/2-translated.Rmd")
random_integer <-
...
#' @eval readLines("man-src/random_normal/2-translated.Rmd")
random_normal <-
...
#' @eval readLines("man-src/random_shuffle/2-translated.Rmd")
random_shuffle <-
...
#' @eval readLines("man-src/random_truncated_normal/2-translated.Rmd")
...
#' @eval readLines("man-src/random_uniform/2-translated.Rmd")
random_uniform <-
...
#' @eval readLines("man-src/random_seed_generator/2-translated.Rmd")
