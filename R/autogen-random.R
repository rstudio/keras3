...
#' @eval readLines("man-roxygen/random_categorical/roxygen.Rmd")
random_categorical <-
...
#' @eval readLines("man-roxygen/random_dropout/roxygen.Rmd")
random_dropout <-
...
#' @eval readLines("man-roxygen/random_integer/roxygen.Rmd")
random_integer <-
...
#' @eval readLines("man-roxygen/random_normal/roxygen.Rmd")
random_normal <-
...
#' @eval readLines("man-roxygen/random_shuffle/roxygen.Rmd")
random_shuffle <-
...
#' @eval readLines("man-roxygen/random_truncated_normal/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/random_uniform/roxygen.Rmd")
random_uniform <-
...
#' @eval readLines("man-roxygen/random_seed_generator/roxygen.Rmd")
