...
#' @eval readLines("man-src/layer_conv_1d/2-translated.Rmd")
layer_conv_1d <-
...
#' @eval readLines("man-src/layer_conv_1d_transpose/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_conv_2d/2-translated.Rmd")
layer_conv_2d <-
...
#' @eval readLines("man-src/layer_conv_2d_transpose/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_conv_3d/2-translated.Rmd")
layer_conv_3d <-
function (object, filters, kernel_size, strides = list(1L, 1L,
...
#' @eval readLines("man-src/layer_conv_3d_transpose/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_depthwise_conv_1d/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_depthwise_conv_2d/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_separable_conv_1d/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_separable_conv_2d/2-translated.Rmd")
