...
#' @eval readLines("man-roxygen/layer_conv_1d/roxygen.Rmd")
layer_conv_1d <-
...
#' @eval readLines("man-roxygen/layer_conv_1d_transpose/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_conv_2d/roxygen.Rmd")
layer_conv_2d <-
...
#' @eval readLines("man-roxygen/layer_conv_2d_transpose/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_conv_3d/roxygen.Rmd")
layer_conv_3d <-
function (object, filters, kernel_size, strides = list(1L, 1L,
...
#' @eval readLines("man-roxygen/layer_conv_3d_transpose/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_depthwise_conv_1d/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_depthwise_conv_2d/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_separable_conv_1d/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_separable_conv_2d/roxygen.Rmd")
