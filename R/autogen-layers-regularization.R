...
#' @eval readLines("man-src/layer_activity_regularization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_dropout/roxygen.Rmd")
layer_dropout <-
...
#' @eval readLines("man-src/layer_gaussian_dropout/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_gaussian_noise/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_spatial_dropout_1d/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_spatial_dropout_2d/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_spatial_dropout_3d/roxygen.Rmd")
