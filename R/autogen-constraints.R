...
#' @eval readLines("man-src/constraint_maxnorm/roxygen.Rmd")
constraint_maxnorm <-
...
#' @eval readLines("man-src/constraint_minmaxnorm/roxygen.Rmd")
...
#' @eval readLines("man-src/constraint_nonneg/roxygen.Rmd")
constraint_nonneg <-
function ()
{
...
#' @eval readLines("man-src/constraint_unitnorm/roxygen.Rmd")
constraint_unitnorm <-
function (axis = 0L)
{
    args <- capture_args2(list(axis = as_axis))
