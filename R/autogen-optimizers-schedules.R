...
#' @eval readLines("man-roxygen/learning_rate_schedule_cosine_decay/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/learning_rate_schedule_cosine_decay_restarts/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/learning_rate_schedule_exponential_decay/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/learning_rate_schedule_inverse_time_decay/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/learning_rate_schedule_piecewise_constant_decay/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/learning_rate_schedule_polynomial_decay/roxygen.Rmd")
