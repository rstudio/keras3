...
#' @eval readLines("man-src/learning_rate_schedule_cosine_decay/2-translated.Rmd")
...
#' @eval readLines("man-src/learning_rate_schedule_cosine_decay_restarts/2-translated.Rmd")
...
#' @eval readLines("man-src/learning_rate_schedule_exponential_decay/2-translated.Rmd")
...
#' @eval readLines("man-src/learning_rate_schedule_inverse_time_decay/2-translated.Rmd")
...
#' @eval readLines("man-src/learning_rate_schedule_piecewise_constant_decay/2-translated.Rmd")
...
#' @eval readLines("man-src/learning_rate_schedule_polynomial_decay/2-translated.Rmd")
