...
#' @eval readLines("man-src/regularizer_l1/roxygen.Rmd")
regularizer_l1 <-
function (l1 = 0.01)
{
...
#' @eval readLines("man-src/regularizer_l1_l2/roxygen.Rmd")
regularizer_l1_l2 <-
function (l1 = 0, l2 = 0)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/regularizer_l2/roxygen.Rmd")
regularizer_l2 <-
function (l2 = 0.01)
{
    args <- capture_args2(NULL)
...
#' @eval readLines("man-src/regularizer_orthogonal/roxygen.Rmd")
