...
#' @eval readLines("man-roxygen/optimizer_adadelta/roxygen.Rmd")
optimizer_adadelta <-
...
#' @eval readLines("man-roxygen/optimizer_adafactor/roxygen.Rmd")
optimizer_adafactor <-
...
#' @eval readLines("man-roxygen/optimizer_adagrad/roxygen.Rmd")
optimizer_adagrad <-
...
#' @eval readLines("man-roxygen/optimizer_adam/roxygen.Rmd")
optimizer_adam <-
...
#' @eval readLines("man-roxygen/optimizer_adamax/roxygen.Rmd")
optimizer_adamax <-
function (learning_rate = 0.001, beta_1 = 0.9, beta_2 = 0.999,
    epsilon = 1e-07, weight_decay = NULL, clipnorm = NULL, clipvalue = NULL,
    global_clipnorm = NULL, use_ema = FALSE, ema_momentum = 0.99,
...
#' @eval readLines("man-roxygen/optimizer_adam_w/roxygen.Rmd")
optimizer_adam_w <-
...
#' @eval readLines("man-roxygen/optimizer_ftrl/roxygen.Rmd")
optimizer_ftrl <-
...
#' @eval readLines("man-roxygen/optimizer_lion/roxygen.Rmd")
optimizer_lion <-
...
#' @eval readLines("man-roxygen/optimizer_loss_scale/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/optimizer_nadam/roxygen.Rmd")
optimizer_nadam <-
function (learning_rate = 0.001, beta_1 = 0.9, beta_2 = 0.999,
    epsilon = 1e-07, weight_decay = NULL, clipnorm = NULL, clipvalue = NULL,
    global_clipnorm = NULL, use_ema = FALSE, ema_momentum = 0.99,
...
#' @eval readLines("man-roxygen/optimizer_rmsprop/roxygen.Rmd")
optimizer_rmsprop <-
...
#' @eval readLines("man-roxygen/optimizer_sgd/roxygen.Rmd")
optimizer_sgd <-
