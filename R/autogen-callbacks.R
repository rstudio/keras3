...
#' @eval readLines("man-roxygen/callback_backup_and_restore/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_csv_logger/roxygen.Rmd")
callback_csv_logger <-
...
#' @eval readLines("man-roxygen/callback_early_stopping/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_lambda/roxygen.Rmd")
callback_lambda <-
...
#' @eval readLines("man-roxygen/callback_learning_rate_scheduler/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_model_checkpoint/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_progbar_logger/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_reduce_lr_on_plateau/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_remote_monitor/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_tensorboard/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/callback_terminate_on_nan/roxygen.Rmd")
