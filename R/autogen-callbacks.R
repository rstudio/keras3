...
#' @eval readLines("man-src/callback_backup_and_restore/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_csv_logger/2-translated.Rmd")
callback_csv_logger <-
...
#' @eval readLines("man-src/callback_early_stopping/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_lambda/2-translated.Rmd")
callback_lambda <-
...
#' @eval readLines("man-src/callback_learning_rate_scheduler/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_model_checkpoint/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_progbar_logger/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_reduce_lr_on_plateau/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_remote_monitor/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_tensorboard/2-translated.Rmd")
...
#' @eval readLines("man-src/callback_terminate_on_nan/2-translated.Rmd")
