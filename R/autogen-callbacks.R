...
#' @eval readLines("man-src/callback_backup_and_restore/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_csv_logger/roxygen.Rmd")
callback_csv_logger <-
...
#' @eval readLines("man-src/callback_early_stopping/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_lambda/roxygen.Rmd")
callback_lambda <-
...
#' @eval readLines("man-src/callback_learning_rate_scheduler/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_model_checkpoint/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_progbar_logger/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_reduce_lr_on_plateau/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_remote_monitor/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_tensorboard/roxygen.Rmd")
...
#' @eval readLines("man-src/callback_terminate_on_nan/roxygen.Rmd")
