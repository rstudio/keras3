...
#' @eval readLines("man-roxygen/layer_additive_attention/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_attention/roxygen.Rmd")
layer_attention <-
...
#' @eval readLines("man-roxygen/layer_group_query_attention/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_multi_head_attention/roxygen.Rmd")
