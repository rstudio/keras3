...
#' @eval readLines("man-src/layer_additive_attention/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_attention/roxygen.Rmd")
layer_attention <-
...
#' @eval readLines("man-src/layer_group_query_attention/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_multi_head_attention/roxygen.Rmd")
