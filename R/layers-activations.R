...
#' - `mask`: A boolean mask broadcastable to `inputs`. The mask specifies 1 to
#'     keep and 0 to mask. Each mask dimension must be 1 or match the
#'     corresponding dimension of `inputs`; it must not be larger. Defaults to
#'     `NULL`.
#'
#' @returns
