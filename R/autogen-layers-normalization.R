...
#' @eval readLines("man-src/layer_batch_normalization/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_group_normalization/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_layer_normalization/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_spectral_normalization/2-translated.Rmd")
...
#' @eval readLines("man-src/layer_unit_normalization/2-translated.Rmd")
