...
#' @eval readLines("man-roxygen/layer_batch_normalization/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_group_normalization/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_layer_normalization/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_spectral_normalization/roxygen.Rmd")
...
#' @eval readLines("man-roxygen/layer_unit_normalization/roxygen.Rmd")
