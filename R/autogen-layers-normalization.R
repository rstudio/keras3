...
#' @eval readLines("man-src/layer_batch_normalization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_group_normalization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_layer_normalization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_spectral_normalization/roxygen.Rmd")
...
#' @eval readLines("man-src/layer_unit_normalization/roxygen.Rmd")
