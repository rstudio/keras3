...
#' @eval readLines("man-src/loss_binary_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_binary_focal_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_categorical_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_categorical_focal_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_categorical_hinge/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_cosine_similarity/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_hinge/roxygen.Rmd")
loss_hinge <-
structure(function (y_true, y_pred, ..., reduction = "sum_over_batch_size",
    name = "hinge")
{
...
#' @eval readLines("man-src/loss_huber/roxygen.Rmd")
loss_huber <-
...
#' @eval readLines("man-src/loss_kl_divergence/roxygen.Rmd")
loss_kl_divergence <-
structure(function (y_true, y_pred, ..., reduction = "sum_over_batch_size",
    name = "kl_divergence")
{
...
#' @eval readLines("man-src/loss_log_cosh/roxygen.Rmd")
loss_log_cosh <-
structure(function (y_true, y_pred, ..., reduction = "sum_over_batch_size",
    name = "log_cosh")
{
...
#' @eval readLines("man-src/loss_mean_absolute_error/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_mean_absolute_percentage_error/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_mean_squared_error/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_mean_squared_logarithmic_error/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_poisson/roxygen.Rmd")
loss_poisson <-
structure(function (y_true, y_pred, ..., reduction = "sum_over_batch_size",
    name = "poisson")
{
...
#' @eval readLines("man-src/loss_sparse_categorical_crossentropy/roxygen.Rmd")
...
#' @eval readLines("man-src/loss_squared_hinge/roxygen.Rmd")
loss_squared_hinge <-
structure(function (y_true, y_pred, ..., reduction = "sum_over_batch_size",
    name = "squared_hinge")
{
