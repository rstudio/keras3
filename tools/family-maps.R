r_name_to_family_map <-
  list(
    ...
    clear_session = c("backend",
                      "utils"),
    config_backend = c("config backend", "backend",
                       "config"),
    ...
    get_custom_objects = c("object registration saving",
                           "saving", "utils"),
    get_file = "utils",
    ...
    k_irfft = c("math ops",
                "ops"),
    k_isclose = c("numpy ops", "ops"),
    k_isfinite = c("numpy ops",
                   "ops"),
    k_isinf = c("numpy ops", "ops"),
    k_isnan = c("numpy ops",
                "ops"),
    k_istft = c("math ops", "ops"),
    k_leaky_relu = c("nn ops",
                     "ops"),
    k_less = c("numpy ops", "ops"),
    k_less_equal = c("numpy ops",
                     "ops"),
    k_linspace = c("numpy ops", "ops"),
    k_log = c("numpy ops",
              "ops"),
    k_log_sigmoid = c("nn ops", "ops"),
    k_log_softmax = c("nn ops",
                      "ops"),
    k_log10 = c("numpy ops", "ops"),
    k_log1p = c("numpy ops",
                "ops"),
    k_log2 = c("numpy ops", "ops"),
    k_logaddexp = c("numpy ops",
                    "ops"),
    k_logical_and = c("numpy ops", "ops"),
    k_logical_not = c("numpy ops",
                      "ops"),
    k_logical_or = c("numpy ops", "ops"),
    k_logical_xor = c("numpy ops",
                      "ops"),
    k_logspace = c("numpy ops", "ops"),
    k_logsumexp = c("math ops",
                    "ops"),
    k_matmul = c("numpy ops", "ops"),
    k_max = c("numpy ops",
              "ops"),
    k_max_pool = c("nn ops", "ops"),
    k_maximum = c("numpy ops",
                  "ops"),
    k_mean = c("numpy ops", "ops"),
    k_median = c("numpy ops",
                 "ops"),
    k_meshgrid = c("numpy ops", "ops"),
    k_min = c("numpy ops",
              "ops"),
    k_minimum = c("numpy ops", "ops"),
    k_mod = c("numpy ops",
              "ops"),
    k_moments = c("nn ops", "ops"),
    k_moveaxis = c("numpy ops",
                   "ops"),
    k_multi_hot = c("nn ops", "ops"),
    k_multiply = c("numpy ops",
                   "ops"),
    k_nan_to_num = c("numpy ops", "ops"),
    k_ndim = c("numpy ops",
               "ops"),
    k_negative = c("numpy ops", "ops"),
    k_nonzero = c("numpy ops",
                  "ops"),
    k_not_equal = c("numpy ops", "ops"),
    k_one_hot = c("nn ops",
                  "ops"),
    k_ones = c("numpy ops", "ops"),
    k_ones_like = c("numpy ops",
                    "ops"),
    k_outer = c("numpy ops", "ops"),
    k_pad = c("numpy ops",
              "ops"),
    k_power = c("numpy ops", "ops"),
    k_prod = c("numpy ops",
               "ops"),
    k_qr = c("math ops", "ops"),
    k_quantile = c("numpy ops",
                   "ops"),
    k_ravel = c("numpy ops", "ops"),
    k_real = c("numpy ops",
               "ops"),
    k_reciprocal = c("numpy ops", "ops"),
    k_relu = c("nn ops",
               "ops"),
    k_relu6 = c("nn ops", "ops"),
    k_repeat = c("numpy ops",
                 "ops"),
    k_reshape = c("numpy ops", "ops"),
    k_rfft = c("math ops",
               "ops"),
    k_roll = c("numpy ops", "ops"),
    k_round = c("numpy ops",
                "ops"),
    k_rsqrt = c("math ops", "ops"),
    k_scatter = c("core ops",
                  "ops"),
    k_scatter_update = c("core ops", "ops"),
    k_segment_max = c("math ops",
                      "ops"),
    k_segment_sum = c("math ops", "ops"),
    k_selu = c("nn ops",
               "ops"),
    k_separable_conv = c("nn ops", "ops"),
    k_shape = c("core ops",
                "ops"),
    k_sigmoid = c("nn ops", "ops"),
    k_sign = c("numpy ops",
               "ops"),
    k_silu = c("nn ops", "ops"),
    k_sin = c("numpy ops",
              "ops"),
    k_sinh = c("numpy ops", "ops"),
    k_size = c("numpy ops",
               "ops"),
    k_slice = c("core ops", "ops"),
    k_slice_update = c("core ops",
                       "ops"),
    k_softmax = c("nn ops", "ops"),
    k_softplus = c("nn ops",
                   "ops"),
    k_softsign = c("nn ops", "ops"),
    k_solve = c("math ops",
                "ops"),
    k_sort = c("numpy ops", "ops"),
    k_sparse_categorical_crossentropy = c("nn ops",
                                          "ops"),
    ...
    k_take = c("numpy ops",
               "ops"),
    k_take_along_axis = c("numpy ops", "ops"),
    k_tan = c("numpy ops",
              "ops"),
    k_tanh = c("numpy ops", "ops"),
    k_tensordot = c("numpy ops",
                    "ops"),
    k_tile = c("numpy ops", "ops"),
    k_top_k = c("math ops",
                "ops"),
    k_trace = c("numpy ops", "ops"),
    k_transpose = c("numpy ops",
                    "ops"),
    k_tri = c("numpy ops", "ops"),
    k_tril = c("numpy ops",
               "ops"),
    k_triu = c("numpy ops", "ops"),
    k_true_divide = c("numpy ops",
                      "ops"),
    k_unstack = c("core ops", "ops"),
    k_var = c("numpy ops",
              "ops"),
    k_vdot = c("numpy ops", "ops"),
    k_vectorized_map = c("core ops",
                         "ops"),
    k_vstack = c("numpy ops", "ops"),
    k_where = c("numpy ops",
                "ops"),
    k_while_loop = c("core ops", "ops"),
    k_zeros = c("numpy ops",
                "ops"),
    k_zeros_like = c("numpy ops", "ops"),
    ...
    metric_auc = c("confusion metrics",
                   "metrics"),
    metric_binary_accuracy = c("accuracy metrics",
                               "metrics"),
    metric_binary_crossentropy = c("losses", "metrics",
                                   "probabilistic metrics"),
    metric_binary_focal_crossentropy = c("losses",
                                         "metrics"),
    metric_binary_iou = c("iou metrics", "metrics"),
    metric_categorical_accuracy = c("accuracy metrics", "metrics"),
    metric_categorical_crossentropy = c("losses", "metrics",
                                        "probabilistic metrics"),
    ...
    text_dataset_from_directory = c("dataset utils",
                                    "text dataset utils", "utils", "preprocessing"),
...
family_to_r_names_map <-
  list(
    ...
    `datum adapter trainers` = c("pack_x_y_sample_weight",
    ...
    trainers = c("pack_x_y_sample_weight", "unpack_x_y_sample_weight"),
    utils = c(
      "config_disable_interactive_logging",
      "config_disable_traceback_filtering",
      "config_enable_interactive_logging",
