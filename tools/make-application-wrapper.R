...
new_application_wrapper <- function(py_obj) {
  ...
  r_wrapper_name <- sprintf("application_%s <- ", snakecase::to_snake_case(py_obj$`__name__`))
...
new_application_wrapper(keras$applications$Xception)
