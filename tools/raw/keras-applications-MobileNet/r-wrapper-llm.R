...
#' @param alpha Controls the width of the network. This is known as the width
...
#'     Defaults to `1.0`.
#' @param dropout Dropout rate. Defaults to `0.001`.
#' @param include_top Boolean, whether to include the fully-connected layer
...
#' @param classifier_activation A `str` or callable. The activation function
